...
S3_BUILDS_BUCKET = os.getenv("S3_BUILDS_BUCKET", "github_actions/altinity-build-artifacts")
S3_TEST_REPORTS_BUCKET = os.getenv("S3_TEST_REPORTS_BUCKET", "github_actions/altinity-build-artifacts")
