...
S3_BUILDS_BUCKET = os.getenv("S3_BUILDS_BUCKET", "altinity-test-new-credentials")
S3_BUILDS_BUCKET_PUBLIC = "altinity-test-new-credentials"
S3_SECRET_ACCESS_KEY = os.getenv("AWS_SECRET_ACCESS_KEY")
S3_TEST_REPORTS_BUCKET = os.getenv("S3_TEST_REPORTS_BUCKET", "altinity-test-new-credentials")
