...
TO dst_1_0
as select id, count() as c from src_table where id % 2 = 0 GROUP BY id;
...
TO dst_1_1
as select id, count() as c from src_table where id % 2 = 1 GROUP BY id;
...
TO dst_1_2
as select id, count() as c from src_table GROUP BY id;
...
TO dst_2_01
as select id, sum(c) as c from dst_1_0 GROUP BY id;
