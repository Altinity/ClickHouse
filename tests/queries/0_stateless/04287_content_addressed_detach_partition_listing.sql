...
-- B36: after DETACH PARTITION on a content_addressed disk, system.detached_parts must list the
...
SETTINGS disk = disk(
    ...
    name = '04287_content_addressed_detach',
    path = '04287_content_addressed_detach_pool/');
