...
# Access control for `SYSTEM CONTENT ADDRESSED FSCK` (mirrors 05011_cas_gc_rebuild_access.sh):
...
#  2) Granting "SYSTEM CONTENT ADDRESSED FSCK" permits the verb; it then fails later, on the
