...
-- Positive test for the part-cloning partition commands on a content_addressed disk.
--
...
-- on the local-CA job that is a local content_addressed disk, on the content_addressed-over-S3 job it is
