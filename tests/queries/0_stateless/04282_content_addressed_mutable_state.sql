...
-- content_addressed disk the two parts dedup to ONE shared manifest, while their mutable per-part
...
-- the content_addressed table must behave exactly like a normal MergeTree table, and the two parts
...
-- Data oracle: the content_addressed table matches the normal table exactly.
