...
ALL_FUNCTIONAL_TESTS = [job.name for job in AltinityJobConfigs.functional_tests_jobs]
...
PLAIN_FUNCTIONAL_TEST_JOB = [
    j for j in AltinityJobConfigs.functional_tests_jobs if "amd_debug, parallel" in j.name
][0]
