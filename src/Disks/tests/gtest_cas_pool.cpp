...
public:
    ...
    DB::Cas::WriteSinkPtr putOverwriteStream(const String & k, const DB::Cas::Token & expected, uint64_t declared_size, const DB::Cas::ObjectMeta & meta) override { ++writes; return inner->putOverwriteStream(k, expected, declared_size, meta); }
...
public:
    ...
    DB::Cas::WriteSinkPtr putOverwriteStream(const String & k, const DB::Cas::Token & expected, uint64_t declared_size, const DB::Cas::ObjectMeta & m) override { note(k); return inner->putOverwriteStream(k, expected, declared_size, m); }
