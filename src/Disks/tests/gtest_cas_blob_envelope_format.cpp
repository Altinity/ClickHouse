...
TEST(CasBlobEnvelopeFormat, FixedLengthAndPadZone)
{
    ...
    const String json = "{\"type\":\"cas_blob\",\"v\":4,\"tag\":\"0102030405060708090a0b0c0d0e0f10\","
