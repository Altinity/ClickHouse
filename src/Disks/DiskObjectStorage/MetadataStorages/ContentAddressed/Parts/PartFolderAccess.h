...
public:
    ...
    /// `allow_repoint` permits replacing a committed ref that names a different manifest.
    ...
    /// prepared before the committed ref is moved.
    ...
    /// cached view, and returns true. `key` must already resolve.
