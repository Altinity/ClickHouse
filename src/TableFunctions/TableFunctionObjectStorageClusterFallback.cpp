...
struct S3ClusterFallbackDefinition
{
    ...
    static constexpr auto storage_engine_cluster_name = "S3Cluster";
};
...
struct AzureClusterFallbackDefinition
{
    ...
    static constexpr auto storage_engine_cluster_name = "AzureBlobStorageCluster";
};
...
struct HDFSClusterFallbackDefinition
{
    ...
    static constexpr auto storage_engine_cluster_name = "HDFSCluster";
};
...
struct IcebergClusterFallbackDefinition
{
    ...
    static constexpr auto storage_engine_cluster_name = "IcebergCluster";
};
...
struct IcebergS3ClusterFallbackDefinition
{
    ...
    static constexpr auto storage_engine_name = "S3";
    static constexpr auto storage_engine_cluster_name = "IcebergS3Cluster";
};
...
struct IcebergAzureClusterFallbackDefinition
{
    ...
    static constexpr auto storage_engine_name = "Azure";
    static constexpr auto storage_engine_cluster_name = "IcebergAzureCluster";
};
...
struct HudiClusterFallbackDefinition
{
    ...
    static constexpr auto storage_engine_name = "S3";
    static constexpr auto storage_engine_cluster_name = "HudiS3Cluster";
};
