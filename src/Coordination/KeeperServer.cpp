...
SSL_CTX* getSslContext()
{
    ...
    // so we need to make sure that wouldn't actually destroy a context.
    SSL_CTX_up_ref(raw_ssl_ctx);

    return raw_ssl_ctx;
}

void setSSLParams(nuraft::asio_service::options & asio_opts, [[maybe_unused]] Poco::LoggerPtr log)
{
