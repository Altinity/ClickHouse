...
class ExportPartitionPlainMergeTreeTask : public IExecutableTask
{
public:
...
using ExportPartitionPlainMergeTreeTaskPtr = std::shared_ptr<ExportPartitionPlainMergeTreeTask>;
