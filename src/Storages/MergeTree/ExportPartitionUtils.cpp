...
namespace ExportPartitionUtils
{
        ...
        const ASTPtr & partition_key_ast)
    {
        ...
        for (size_t i = 0; i < expected_size; ++i)
        {
            ...
            const auto expected_canonical = Iceberg::parseTransformAndArgument(expected_transform, /* time_zone */ "");
            const auto actual_canonical   = Iceberg::parseTransformAndArgument(actual_transform, /* time_zone */ "");
