...
)
{
    ...
    {
        LOG_INFO(storage.log, "ExportPartition scheduler task: Part {} failed with retryable error (code {}), will back off and retry until the task timeout", part_name, exception->code());
    }
