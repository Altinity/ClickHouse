...
ColumnsDescription ContentAddressedLogElement::getColumnsDescription()
{
    ...
    return ColumnsDescription
    {
        ...
        {"event_type", lc_string, "The CA decision/event (blob_put, blob_reuse_adopt, root_remove, indeg_zero, gc_retire_decision, gc_recheck_verdict, blob_delete, dangling_access, corrupt_dangle, ...)."},
        ...
        {"object_kind", lc_string, "none/blob/manifest/root/snap."},
