...
#define APPLY_FOR_ACCESS_TYPES(M) \
    ...
    M(SYSTEM_CONTENT_ADDRESSED_DROP_POOL_MEMBER, "SYSTEM CONTENT ADDRESSED DROP POOL MEMBER", GLOBAL, SYSTEM) \
    M(SYSTEM_CONTENT_ADDRESSED_UNMOUNT, "SYSTEM CONTENT ADDRESSED UNMOUNT", GLOBAL, SYSTEM) \
    M(SYSTEM_CONTENT_ADDRESSED_MOUNT, "SYSTEM CONTENT ADDRESSED MOUNT", GLOBAL, SYSTEM) \
    M(SYSTEM_CONTENT_ADDRESSED_FSCK, "SYSTEM CONTENT ADDRESSED FSCK", GLOBAL, SYSTEM) \
    M(SYSTEM_CONTENT_ADDRESSED_FORGET, "SYSTEM CONTENT ADDRESSED FORGET", GLOBAL, SYSTEM) \
    M(SYSTEM_CONTENT_ADDRESSED_GC_STOP, "SYSTEM CONTENT ADDRESSED GC STOP", GLOBAL, SYSTEM) \
    M(SYSTEM_CONTENT_ADDRESSED_GC_START, "SYSTEM CONTENT ADDRESSED GC START", GLOBAL, SYSTEM) \
