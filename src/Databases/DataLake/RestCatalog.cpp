...
DB::HTTPHeaderEntries OneLakeCatalog::getAuthHeaders(
    ...
    const String & body) const
{
    auto headers = RestCatalog::getAuthHeaders(catalog_state, update_token, method, url, extra_headers, body);
    ...
    const String & body) const
{
    ...
    return RestCatalog::getAuthHeaders(catalog_state, update_token, method, url, extra_headers, body);
}
    ...
    const std::optional<DB::HTTPHeaderEntries> & auth_headers) const
{
    ...
    auto create_buffer = [&](bool update_token)
    {
        auto result_headers = auth_headers
            ? *auth_headers
            : getAuthHeaders(catalog_state, update_token, Poco::Net::HTTPRequest::HTTP_GET, url, headers, {});
...
void RestCatalog::sendRequest(const CatalogState & catalog_state, const String & endpoint, Poco::JSON::Object::Ptr request_body, const String & method, bool ignore_result) const
{
    ...
    DB::HTTPHeaderEntries headers = getAuthHeaders(catalog_state, /* update_token = */ true, method, url, extra_headers, body_str);
