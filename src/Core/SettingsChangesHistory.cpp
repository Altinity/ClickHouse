...
const VersionToSettingsChangesMap & getSettingsChangesHistory()
{
    ...
    std::call_once(initialized_flag, [&]
    {
        ...
        addSettingsChanges(settings_changes_history, "26.6.2.20001.altinityantalya",
        {
            ...
            {"input_format_parquet_compressed_memory_fraction", 0.35, 0.35, "New setting: share of the Parquet reader memory budget held as compressed pages in flight; replaces the previous fixed per-stage split, which gave the data read 20% of the budget."},
        });
