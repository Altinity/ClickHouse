...
const VersionToSettingsChangesMap & getSettingsChangesHistory()
{
    ...
    std::call_once(initialized_flag, [&]
    {
        ...
        addSettingsChanges(settings_changes_history, "25.4",
        {
            ...
            {"allow_experimental_shared_set_join", 0, 1, "A setting to enable SharedSet and SharedJoin"},
        ...
        addSettingsChanges(settings_changes_history, "24.10",
        {
            ...
            {"cloud_mode_database_engine", 1, 1, "Internal setting"},
            {"allow_experimental_shared_set_join", 0, 0, "Internal setting"},
            {"read_through_distributed_cache", 0, 0, "Internal setting"},
            {"write_through_distributed_cache", 0, 0, "Internal setting"},
            {"distributed_cache_throw_on_error", 0, 0, "Internal setting"},
            {"distributed_cache_log_mode", "on_error", "on_error", "Internal setting"},
            {"distributed_cache_fetch_metrics_only_from_current_az", 1, 1, "Internal setting"},
            {"distributed_cache_connect_max_tries", 20, 20, "Internal setting"},
            {"distributed_cache_receive_response_wait_milliseconds", 60000, 60000, "Internal setting"},
            {"distributed_cache_receive_timeout_milliseconds", 10000, 10000, "Internal setting"},
            {"distributed_cache_wait_connection_from_pool_milliseconds", 100, 100, "Internal setting"},
            {"distributed_cache_bypass_connection_pool", 0, 0, "Internal setting"},
            {"distributed_cache_pool_behaviour_on_limit", "allocate_bypassing_pool", "allocate_bypassing_pool", "Internal setting"},
            {"distributed_cache_read_alignment", 0, 0, "Internal setting"},
            {"distributed_cache_max_unacked_inflight_packets", 10, 10, "Internal setting"},
            {"distributed_cache_data_packet_ack_window", 5, 5, "Internal setting"},
