...
database engine, whose `oauth_forward_user_token` setting makes an Iceberg REST catalog or a Glue
catalog authorize the human running the query instead of a shared service identity. See
