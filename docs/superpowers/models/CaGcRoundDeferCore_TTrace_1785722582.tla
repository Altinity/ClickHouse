---- MODULE CaGcRoundDeferCore_TTrace_1785722582 ----
...
_prop ==
    ~<>[](
        ...
        present = ((b1 :> TRUE))
        /\
        unfolded = ({[b |-> b1, w |-> w1, op |-> "add"], [b |-> b1, w |-> w2, op |-> "add"]})
        /\
        folded = ({})
        /\
        minAck = (4)
...
\* to `JsonSerialize`. For example, a sub-sequence of _TETrace.
    \* ASSUME
    \*     LET J == INSTANCE Json
    \*         IN J!JsonSerialize("CaGcRoundDeferCore_TTrace_1785722582.json", _TETrace)
...
\*
\*trace == IODeserialize("CaGcRoundDeferCore_TTrace_1785722582.bin", TRUE)
\*
\*=============================================================================
\*
...
trace == 
    ...
    ([deferredWithUnfoldedEver |-> FALSE,round |-> 0,minAckL |-> 0,gcPhase |-> "idle",deferCount |-> 0,retired |-> {},present |-> (b1 :> TRUE),unfolded |-> {[b |-> b1, w |-> w1, op |-> "add"]},folded |-> {},minAck |-> 0,deletedThisStep |-> {}]),
    ([deferredWithUnfoldedEver |-> TRUE,round |-> 1,minAckL |-> 0,gcPhase |-> "idle",deferCount |-> 1,retired |-> {},present |-> (b1 :> TRUE),unfolded |-> {[b |-> b1, w |-> w1, op |-> "add"]},folded |-> {},minAck |-> 0,deletedThisStep |-> {}]),
    ([deferredWithUnfoldedEver |-> TRUE,round |-> 1,minAckL |-> 0,gcPhase |-> "idle",deferCount |-> 1,retired |-> {},present |-> (b1 :> TRUE),unfolded |-> {[b |-> b1, w |-> w1, op |-> "add"], [b |-> b1, w |-> w2, op |-> "add"]},folded |-> {},minAck |-> 0,deletedThisStep |-> {}]),
    ([deferredWithUnfoldedEver |-> TRUE,round |-> 2,minAckL |-> 0,gcPhase |-> "idle",deferCount |-> 2,retired |-> {},present |-> (b1 :> TRUE),unfolded |-> {[b |-> b1, w |-> w1, op |-> "add"], [b |-> b1, w |-> w2, op |-> "add"]},folded |-> {},minAck |-> 0,deletedThisStep |-> {}]),
    ([deferredWithUnfoldedEver |-> TRUE,round |-> 2,minAckL |-> 0,gcPhase |-> "idle",deferCount |-> 2,retired |-> {},present |-> (b1 :> TRUE),unfolded |-> {[b |-> b1, w |-> w1, op |-> "add"], [b |-> b1, w |-> w2, op |-> "add"]},folded |-> {},minAck |-> 1,deletedThisStep |-> {}]),
    ([deferredWithUnfoldedEver |-> TRUE,round |-> 3,minAckL |-> 0,gcPhase |-> "idle",deferCount |-> 3,retired |-> {},present |-> (b1 :> TRUE),unfolded |-> {[b |-> b1, w |-> w1, op |-> "add"], [b |-> b1, w |-> w2, op |-> "add"]},folded |-> {},minAck |-> 1,deletedThisStep |-> {}]),
    ([deferredWithUnfoldedEver |-> TRUE,round |-> 4,minAckL |-> 0,gcPhase |-> "idle",deferCount |-> 3,retired |-> {},present |-> (b1 :> TRUE),unfolded |-> {[b |-> b1, w |-> w1, op |-> "add"], [b |-> b1, w |-> w2, op |-> "add"]},folded |-> {},minAck |-> 1,deletedThisStep |-> {}]),
    ([deferredWithUnfoldedEver |-> TRUE,round |-> 4,minAckL |-> 0,gcPhase |-> "idle",deferCount |-> 3,retired |-> {},present |-> (b1 :> TRUE),unfolded |-> {[b |-> b1, w |-> w1, op |-> "add"], [b |-> b1, w |-> w2, op |-> "add"]},folded |-> {},minAck |-> 2,deletedThisStep |-> {}]),
    ([deferredWithUnfoldedEver |-> TRUE,round |-> 4,minAckL |-> 0,gcPhase |-> "idle",deferCount |-> 3,retired |-> {},present |-> (b1 :> TRUE),unfolded |-> {[b |-> b1, w |-> w1, op |-> "add"], [b |-> b1, w |-> w2, op |-> "add"]},folded |-> {},minAck |-> 3,deletedThisStep |-> {}]),
    ([deferredWithUnfoldedEver |-> TRUE,round |-> 4,minAckL |-> 0,gcPhase |-> "idle",deferCount |-> 3,retired |-> {},present |-> (b1 :> TRUE),unfolded |-> {[b |-> b1, w |-> w1, op |-> "add"], [b |-> b1, w |-> w2, op |-> "add"]},folded |-> {},minAck |-> 4,deletedThisStep |-> {}])
    >>
----
...
---- CONFIG CaGcRoundDeferCore_TTrace_1785722582 ----
CONSTANTS
    Writers = { w1 , w2 }
    Blobs = { b1 }
    MaxRound = 4
    MaxDefer = 3
    SabotageGraduateOnStale = FALSE
    SabotageUnboundedDefer = TRUE
    w1 = w1
    w2 = w2
    b1 = b1
...
ALIAS
    _expression
=============================================================================
\* Generated on Mon Aug 03 04:03:03 CEST 2026