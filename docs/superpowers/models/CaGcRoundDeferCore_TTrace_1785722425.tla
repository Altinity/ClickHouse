---- MODULE CaGcRoundDeferCore_TTrace_1785722425 ----
...
\* to `JsonSerialize`. For example, a sub-sequence of _TETrace.
    \* ASSUME
    \*     LET J == INSTANCE Json
    \*         IN J!JsonSerialize("CaGcRoundDeferCore_TTrace_1785722425.json", _TETrace)
...
\*
\*trace == IODeserialize("CaGcRoundDeferCore_TTrace_1785722425.bin", TRUE)
\*
\*=============================================================================
\*
...
trace == 
    ...
    ([deferredWithUnfoldedEver |-> TRUE,round |-> 2,minAckL |-> 0,gcPhase |-> "idle",deferCount |-> 2,retired |-> {},present |-> (b1 :> TRUE),unfolded |-> {[b |-> b1, w |-> w1, op |-> "add"]},folded |-> {},minAck |-> 0,deletedThisStep |-> {}]),
    ([deferredWithUnfoldedEver |-> TRUE,round |-> 3,minAckL |-> 0,gcPhase |-> "idle",deferCount |-> 3,retired |-> {},present |-> (b1 :> TRUE),unfolded |-> {[b |-> b1, w |-> w1, op |-> "add"]},folded |-> {},minAck |-> 0,deletedThisStep |-> {}]),
    ([deferredWithUnfoldedEver |-> TRUE,round |-> 3,minAckL |-> 0,gcPhase |-> "running",deferCount |-> 3,retired |-> {},present |-> (b1 :> TRUE),unfolded |-> {[b |-> b1, w |-> w1, op |-> "add"]},folded |-> {},minAck |-> 0,deletedThisStep |-> {}]),
    ([deferredWithUnfoldedEver |-> TRUE,round |-> 3,minAckL |-> 0,gcPhase |-> "folded",deferCount |-> 0,retired |-> {},present |-> (b1 :> TRUE),unfolded |-> {},folded |-> {[b |-> b1, w |-> w1]},minAck |-> 0,deletedThisStep |-> {}])
    >>
----
...
---- CONFIG CaGcRoundDeferCore_TTrace_1785722425 ----
CONSTANTS
    Writers = { w1 , w2 }
    Blobs = { b1 }
    MaxRound = 4
...
ALIAS
    _expression
=============================================================================
\* Generated on Mon Aug 03 04:00:26 CEST 2026