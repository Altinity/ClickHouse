---- MODULE CaGcCondemnMarkerGate_TTrace_1785646546 ----
...
\* to `JsonSerialize`. For example, a sub-sequence of _TETrace.
    \* ASSUME
    \*     LET J == INSTANCE Json
    \*         IN J!JsonSerialize("CaGcCondemnMarkerGate_TTrace_1785646546.json", _TETrace)
...
\*
\*trace == IODeserialize("CaGcCondemnMarkerGate_TTrace_1785646546.bin", TRUE)
\*
\*=============================================================================
\*
...
---- CONFIG CaGcCondemnMarkerGate_TTrace_1785646546 ----
CONSTANTS
    GateOnMarker = FALSE
    MaxGen = 3
    MaxRounds = 6
...
ALIAS
    _expression
=============================================================================
\* Generated on Sun Aug 02 06:55:46 CEST 2026