---- MODULE CaB140DangleMerge_TTrace_1785722448 ----
...
_inv ==
    ~(
        ...
        /\
        gcState = ([cursor |-> 3, snapGeneration |-> 1])
        /\
...
\* to `JsonSerialize`. For example, a sub-sequence of _TETrace.
    \* ASSUME
    \*     LET J == INSTANCE Json
    \*         IN J!JsonSerialize("CaB140DangleMerge_TTrace_1785722448.json", _TETrace)
...
\*
\*trace == IODeserialize("CaB140DangleMerge_TTrace_1785722448.bin", TRUE)
\*
\*=============================================================================
\*
...
trace == 
    ...
    ([phase |-> (L1 :> "building" @@ L2 :> "retiring"),logBase |-> 1,log |-> <<[op |-> "add", h |-> t2], [op |-> "rem", h |-> t2]>>,gcState |-> [cursor |-> 3, snapGeneration |-> 1],durSnap |-> (0 :> [marker |-> {}, treeEdges |-> {}, rootEdges |-> {}, known |-> {}, cursor |-> 0] @@ 1 :> [marker |-> {}, treeEdges |-> {}, rootEdges |-> {}, known |-> {t2, b1}, cursor |-> 3] @@ 2 :> [marker |-> {}, treeEdges |-> {}, rootEdges |-> {}, known |-> {}, cursor |-> 0] @@ 3 :> [marker |-> {}, treeEdges |-> {}, rootEdges |-> {}, known |-> {}, cursor |-> 0]),refs |-> {t1},durWritten |-> {0, 1},everLost |-> {},retired |-> {},buildGen |-> (L1 :> 1 @@ L2 :> 1),lease |-> L2,present |-> (t1 :> TRUE @@ t2 :> TRUE @@ b1 :> TRUE),wip |-> (L1 :> [marker |-> {t1}, treeEdges |-> {<<t1, b1>>}, rootEdges |-> {t1}, known |-> {t1, b1}, cursor |-> 1] @@ L2 :> [marker |-> {}, treeEdges |-> {}, rootEdges |-> {}, known |-> {t2, b1}, cursor |-> 3])]),
...
---- CONFIG CaB140DangleMerge_TTrace_1785722448 ----
CONSTANTS
    Leaders = { L1 , L2 }
    Trees = { t1 , t2 }
    Blobs = { b1 }
...
ALIAS
    _expression
=============================================================================
\* Generated on Mon Aug 03 04:00:53 CEST 2026