---- MODULE CaGcShardIncarnationCore_TTrace_1785722337 ----
...
\* to `JsonSerialize`. For example, a sub-sequence of _TETrace.
    \* ASSUME
    \*     LET J == INSTANCE Json
    \*         IN J!JsonSerialize("CaGcShardIncarnationCore_TTrace_1785722337.json", _TETrace)
...
\*
\*trace == IODeserialize("CaGcShardIncarnationCore_TTrace_1785722337.bin", TRUE)
\*
\*=============================================================================
\*
...
trace == 
    ...
    ([cursor |-> (n1 :> [inc |-> 1, pos |-> 3] @@ n2 :> [inc |-> 0, pos |-> 0]),deadTok |-> (b1 :> {1}),sIncMax |-> (n1 :> 2 @@ n2 :> 0),log |-> (n1 :> <<[op |-> "add", b |-> b1]>> @@ n2 :> <<>>),tomb |-> (n1 :> FALSE @@ n2 :> FALSE),fencePos |-> (n1 :> 0 @@ n2 :> 0),rootEdges |-> {},wView |-> (w1 :> 1 @@ w2 :> 0),nextTok |-> (b1 :> 3),everEdged |-> {b1},inflight |-> {},sPresent |-> (n1 :> TRUE @@ n2 :> FALSE),wHave |-> (w1 :> {} @@ w2 :> {}),roundOf |-> (L1 :> 1),tokOf |-> (b1 :> 2),refs |-> (n1 :> {<<b1, 2>>} @@ n2 :> {}),gcPhase |-> (L1 :> "fenced"),fencedSet |-> (L1 :> {}),retired |-> {},gcRound |-> 1,present |-> (b1 :> TRUE),fence |-> (n1 :> 1 @@ n2 :> 0),sInc |-> (n1 :> 2 @@ n2 :> 0)]),
    ([cursor |-> (n1 :> [inc |-> 1, pos |-> 3] @@ n2 :> [inc |-> 0, pos |-> 0]),deadTok |-> (b1 :> {1}),sIncMax |-> (n1 :> 2 @@ n2 :> 0),log |-> (n1 :> <<[op |-> "add", b |-> b1]>> @@ n2 :> <<>>),tomb |-> (n1 :> FALSE @@ n2 :> FALSE),fencePos |-> (n1 :> 0 @@ n2 :> 0),rootEdges |-> {},wView |-> (w1 :> 1 @@ w2 :> 0),nextTok |-> (b1 :> 3),everEdged |-> {b1},inflight |-> {},sPresent |-> (n1 :> TRUE @@ n2 :> FALSE),wHave |-> (w1 :> {} @@ w2 :> {}),roundOf |-> (L1 :> 1),tokOf |-> (b1 :> 2),refs |-> (n1 :> {<<b1, 2>>} @@ n2 :> {}),gcPhase |-> (L1 :> "idle"),fencedSet |-> (L1 :> {}),retired |-> {},gcRound |-> 1,present |-> (b1 :> TRUE),fence |-> (n1 :> 1 @@ n2 :> 0),sInc |-> (n1 :> 2 @@ n2 :> 0)]),
    ([cursor |-> (n1 :> [inc |-> 1, pos |-> 3] @@ n2 :> [inc |-> 0, pos |-> 0]),deadTok |-> (b1 :> {1}),sIncMax |-> (n1 :> 2 @@ n2 :> 0),log |-> (n1 :> <<[op |-> "add", b |-> b1]>> @@ n2 :> <<>>),tomb |-> (n1 :> FALSE @@ n2 :> FALSE),fencePos |-> (n1 :> 0 @@ n2 :> 0),rootEdges |-> {},wView |-> (w1 :> 1 @@ w2 :> 0),nextTok |-> (b1 :> 3),everEdged |-> {b1},inflight |-> {},sPresent |-> (n1 :> TRUE @@ n2 :> FALSE),wHave |-> (w1 :> {} @@ w2 :> {}),roundOf |-> (L1 :> 2),tokOf |-> (b1 :> 2),refs |-> (n1 :> {<<b1, 2>>} @@ n2 :> {}),gcPhase |-> (L1 :> "retiring"),fencedSet |-> (L1 :> {}),retired |-> {},gcRound |-> 2,present |-> (b1 :> TRUE),fence |-> (n1 :> 1 @@ n2 :> 0),sInc |-> (n1 :> 2 @@ n2 :> 0)]),
    ([cursor |-> (n1 :> [inc |-> 1, pos |-> 3] @@ n2 :> [inc |-> 0, pos |-> 0]),deadTok |-> (b1 :> {1}),sIncMax |-> (n1 :> 2 @@ n2 :> 0),log |-> (n1 :> <<[op |-> "add", b |-> b1]>> @@ n2 :> <<>>),tomb |-> (n1 :> FALSE @@ n2 :> FALSE),fencePos |-> (n1 :> 0 @@ n2 :> 0),rootEdges |-> {},wView |-> (w1 :> 1 @@ w2 :> 0),nextTok |-> (b1 :> 3),everEdged |-> {b1},inflight |-> {},sPresent |-> (n1 :> TRUE @@ n2 :> FALSE),wHave |-> (w1 :> {} @@ w2 :> {}),roundOf |-> (L1 :> 2),tokOf |-> (b1 :> 2),refs |-> (n1 :> {<<b1, 2>>} @@ n2 :> {}),gcPhase |-> (L1 :> "retiring"),fencedSet |-> (L1 :> {}),retired |-> {[b |-> b1, t |-> 2, r |-> 2]},gcRound |-> 2,present |-> (b1 :> TRUE),fence |-> (n1 :> 1 @@ n2 :> 0),sInc |-> (n1 :> 2 @@ n2 :> 0)]),
    ([cursor |-> (n1 :> [inc |-> 1, pos |-> 3] @@ n2 :> [inc |-> 0, pos |-> 0]),deadTok |-> (b1 :> {1}),sIncMax |-> (n1 :> 2 @@ n2 :> 0),log |-> (n1 :> <<[op |-> "add", b |-> b1], [op |-> "fence", b |-> "none"]>> @@ n2 :> <<>>),tomb |-> (n1 :> FALSE @@ n2 :> FALSE),fencePos |-> (n1 :> 2 @@ n2 :> 0),rootEdges |-> {},wView |-> (w1 :> 1 @@ w2 :> 0),nextTok |-> (b1 :> 3),everEdged |-> {b1},inflight |-> {},sPresent |-> (n1 :> TRUE @@ n2 :> FALSE),wHave |-> (w1 :> {} @@ w2 :> {}),roundOf |-> (L1 :> 2),tokOf |-> (b1 :> 2),refs |-> (n1 :> {<<b1, 2>>} @@ n2 :> {}),gcPhase |-> (L1 :> "fenced"),fencedSet |-> (L1 :> {n1}),retired |-> {[b |-> b1, t |-> 2, r |-> 2]},gcRound |-> 2,present |-> (b1 :> TRUE),fence |-> (n1 :> 2 @@ n2 :> 0),sInc |-> (n1 :> 2 @@ n2 :> 0)]),
    ([cursor |-> (n1 :> [inc |-> 1, pos |-> 3] @@ n2 :> [inc |-> 0, pos |-> 0]),deadTok |-> (b1 :> {1}),sIncMax |-> (n1 :> 2 @@ n2 :> 0),log |-> (n1 :> <<[op |-> "add", b |-> b1], [op |-> "fence", b |-> "none"]>> @@ n2 :> <<>>),tomb |-> (n1 :> FALSE @@ n2 :> FALSE),fencePos |-> (n1 :> 2 @@ n2 :> 0),rootEdges |-> {},wView |-> (w1 :> 1 @@ w2 :> 0),nextTok |-> (b1 :> 3),everEdged |-> {b1},inflight |-> {[b |-> b1, t |-> 2]},sPresent |-> (n1 :> TRUE @@ n2 :> FALSE),wHave |-> (w1 :> {} @@ w2 :> {}),roundOf |-> (L1 :> 2),tokOf |-> (b1 :> 2),refs |-> (n1 :> {<<b1, 2>>} @@ n2 :> {}),gcPhase |-> (L1 :> "fenced"),fencedSet |-> (L1 :> {n1}),retired |-> {[b |-> b1, t |-> 2, r |-> 2]},gcRound |-> 2,present |-> (b1 :> TRUE),fence |-> (n1 :> 2 @@ n2 :> 0),sInc |-> (n1 :> 2 @@ n2 :> 0)]),
    ([cursor |-> (n1 :> [inc |-> 1, pos |-> 3] @@ n2 :> [inc |-> 0, pos |-> 0]),deadTok |-> (b1 :> {1, 2}),sIncMax |-> (n1 :> 2 @@ n2 :> 0),log |-> (n1 :> <<[op |-> "add", b |-> b1], [op |-> "fence", b |-> "none"]>> @@ n2 :> <<>>),tomb |-> (n1 :> FALSE @@ n2 :> FALSE),fencePos |-> (n1 :> 2 @@ n2 :> 0),rootEdges |-> {},wView |-> (w1 :> 1 @@ w2 :> 0),nextTok |-> (b1 :> 3),everEdged |-> {b1},inflight |-> {},sPresent |-> (n1 :> TRUE @@ n2 :> FALSE),wHave |-> (w1 :> {} @@ w2 :> {}),roundOf |-> (L1 :> 2),tokOf |-> (b1 :> 2),refs |-> (n1 :> {<<b1, 2>>} @@ n2 :> {}),gcPhase |-> (L1 :> "fenced"),fencedSet |-> (L1 :> {n1}),retired |-> {},gcRound |-> 2,present |-> (b1 :> FALSE),fence |-> (n1 :> 2 @@ n2 :> 0),sInc |-> (n1 :> 2 @@ n2 :> 0)])
    >>
----
...
---- CONFIG CaGcShardIncarnationCore_TTrace_1785722337 ----
CONSTANTS
    Blobs = { b1 }
    Shards = { n1 , n2 }
    Writers = { w1 , w2 }
...
ALIAS
    _expression
=============================================================================
\* Generated on Mon Aug 03 03:58:59 CEST 2026