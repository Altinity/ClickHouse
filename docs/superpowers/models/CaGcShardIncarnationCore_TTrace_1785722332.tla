---- MODULE CaGcShardIncarnationCore_TTrace_1785722332 ----
...
_inv ==
    ~(
        ...
        /\
        cursor = ((n1 :> [inc |-> 1, pos |-> 1] @@ n2 :> [inc |-> 0, pos |-> 0]))
        /\
        deadTok = ((b1 :> {}))
        /\
        sIncMax = ((n1 :> 1 @@ n2 :> 0))
        /\
        log = ((n1 :> <<[op |-> "add", b |-> b1], [op |-> "rem", b |-> b1], [op |-> "tomb", b |-> "none"]>> @@ n2 :> <<>>))
        /\
...
\* to `JsonSerialize`. For example, a sub-sequence of _TETrace.
    \* ASSUME
    \*     LET J == INSTANCE Json
    \*         IN J!JsonSerialize("CaGcShardIncarnationCore_TTrace_1785722332.json", _TETrace)
...
\*
\*trace == IODeserialize("CaGcShardIncarnationCore_TTrace_1785722332.bin", TRUE)
\*
\*=============================================================================
\*
...
trace == 
    ...
    ([cursor |-> (n1 :> [inc |-> 1, pos |-> 1] @@ n2 :> [inc |-> 0, pos |-> 0]),deadTok |-> (b1 :> {}),sIncMax |-> (n1 :> 1 @@ n2 :> 0),log |-> (n1 :> <<[op |-> "add", b |-> b1], [op |-> "rem", b |-> b1], [op |-> "tomb", b |-> "none"]>> @@ n2 :> <<>>),tomb |-> (n1 :> FALSE @@ n2 :> FALSE),fencePos |-> (n1 :> 0 @@ n2 :> 0),rootEdges |-> {<<n1, b1>>},wView |-> (w1 :> 0 @@ w2 :> 0),nextTok |-> (b1 :> 2),everEdged |-> {b1},inflight |-> {},sPresent |-> (n1 :> FALSE @@ n2 :> FALSE),wHave |-> (w1 :> {} @@ w2 :> {}),roundOf |-> (L1 :> 0),tokOf |-> (b1 :> 1),refs |-> (n1 :> {} @@ n2 :> {}),gcPhase |-> (L1 :> "idle"),fencedSet |-> (L1 :> {}),retired |-> {},gcRound |-> 0,present |-> (b1 :> TRUE),fence |-> (n1 :> 0 @@ n2 :> 0),sInc |-> (n1 :> 1 @@ n2 :> 0)])
    >>
----
...
---- CONFIG CaGcShardIncarnationCore_TTrace_1785722332 ----
CONSTANTS
    Blobs = { b1 }
    Shards = { n1 , n2 }
    Writers = { w1 , w2 }
...
ALIAS
    _expression
=============================================================================
\* Generated on Mon Aug 03 03:58:53 CEST 2026