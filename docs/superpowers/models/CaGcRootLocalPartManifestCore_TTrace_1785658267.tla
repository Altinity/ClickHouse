---- MODULE CaGcRootLocalPartManifestCore_TTrace_1785658267 ----
...
_inv ==
    ~(
        ...
        /\
        mNs = ((<<n1, m1>> :> n2 @@ <<n1, m2>> :> n2 @@ <<n2, m1>> :> n2 @@ <<n2, m2>> :> n2))
        /\
        ...
        reducerOwner = ((s1 :> L1))
        /\
        mEntries = ((<<n1, m1>> :> (p1 :> b1) @@ <<n1, m2>> :> (p1 :> b1) @@ <<n2, m1>> :> (p1 :> "noblob") @@ <<n2, m2>> :> (p1 :> "noblob")))
        /\
        attViewable = ((0 :> {} @@ 1 :> {} @@ 2 :> {}))
        /\
        retired = ({})
        ...
        inflight = ({})
        /\
        mBody = ((<<n1, m1>> :> TRUE @@ <<n1, m2>> :> TRUE @@ <<n2, m1>> :> FALSE @@ <<n2, m2>> :> FALSE))
        /\
        retiredAt = ((0 :> {} @@ 1 :> {} @@ 2 :> {}))
        /\
        foldedTok = ((n1 :> 0 @@ n2 :> 0))
...
\* to `JsonSerialize`. For example, a sub-sequence of _TETrace.
    \* ASSUME
    \*     LET J == INSTANCE Json
    \*         IN J!JsonSerialize("CaGcRootLocalPartManifestCore_TTrace_1785658267.json", _TETrace)
...
\*
\*trace == IODeserialize("CaGcRootLocalPartManifestCore_TTrace_1785658267.bin", TRUE)
\*
\*=============================================================================
\*
...
trace == 
    ...
    ([cursor |-> (n1 :> 0 @@ n2 :> 0),deadTok |-> (b1 :> {}),blobEdges |-> {},shardIndeg |-> (s1 :> (b1 :> 0)),listedTok |-> (n1 :> 0 @@ n2 :> 0),attemptSeq |-> 0,fencePos |-> (n1 :> 0 @@ n2 :> 0),trimBase |-> (n1 :> 0 @@ n2 :> 0),wView |-> (w1 :> 0),foldTok |-> (n1 :> 0 @@ n2 :> 0),nextTok |-> (b1 :> 1),storedTok |-> (b1 :> 0),roundOf |-> (L1 :> 0),tokOf |-> (b1 :> 0),sweepEligible |-> (bp1 :> FALSE),mNs |-> (<<n1, m1>> :> n2 @@ <<n1, m2>> :> n2 @@ <<n2, m1>> :> n2 @@ <<n2, m2>> :> n2),journal |-> (n1 :> <<>> @@ n2 :> <<>>),mRef |-> (<<n1, m1>> :> <<n1, m1>> @@ <<n1, m2>> :> <<n1, m2>> @@ <<n2, m1>> :> <<n2, m1>> @@ <<n2, m2>> :> <<n2, m2>>),gcPhase |-> (L1 :> "idle"),coordFence |-> (n1 :> 0 @@ n2 :> 0),reducerOwner |-> (s1 :> L1),mEntries |-> (<<n1, m1>> :> (p1 :> b1) @@ <<n1, m2>> :> (p1 :> b1) @@ <<n2, m1>> :> (p1 :> "noblob") @@ <<n2, m2>> :> (p1 :> "noblob")),attViewable |-> (0 :> {} @@ 1 :> {} @@ 2 :> {}),retired |-> {},gcRound |-> 0,blobIndeg |-> (b1 :> 0),mPrefix |-> (<<n1, m1>> :> bp1 @@ <<n1, m2>> :> bp1 @@ <<n2, m1>> :> bp1 @@ <<n2, m2>> :> bp1),extraShared |-> {},owner |-> (<<n1, m1>> :> "none" @@ <<n1, m2>> :> "none" @@ <<n2, m1>> :> "none" @@ <<n2, m2>> :> "none"),foldSeal |-> (0 :> [foldedCursor |-> (n1 :> 0 @@ n2 :> 0), classified |-> {}] @@ 1 :> [foldedCursor |-> (n1 :> 0 @@ n2 :> 0), classified |-> {}] @@ 2 :> [foldedCursor |-> (n1 :> 0 @@ n2 :> 0), classified |-> {}]),prevFencePos |-> (n1 :> 0 @@ n2 :> 0),sealAt |-> (0 :> {} @@ 1 :> {} @@ 2 :> {}),everEdged |-> {<<n1, m1>>, <<n1, m2>>},fenceVersion |-> (0 :> (n1 :> 0 @@ n2 :> 0) @@ 1 :> (n1 :> 0 @@ n2 :> 0) @@ 2 :> (n1 :> 0 @@ n2 :> 0)),mActiveEdges |-> (<<n1, m1>> :> (p1 :> "noblob") @@ <<n1, m2>> :> (p1 :> "noblob") @@ <<n2, m1>> :> (p1 :> "noblob") @@ <<n2, m2>> :> (p1 :> "noblob")),completionSeal |-> (0 :> [fenced |-> {}, rechecked |-> {}, deleted |-> {}, adoptable |-> FALSE] @@ 1 :> [fenced |-> {}, rechecked |-> {}, deleted |-> {}, adoptable |-> FALSE] @@ 2 :> [fenced |-> {}, rechecked |-> {}, deleted |-> {}, adoptable |-> FALSE]),mfCleanup |-> {},inflight |-> {},mBody |-> (<<n1, m1>> :> TRUE @@ <<n1, m2>> :> TRUE @@ <<n2, m1>> :> FALSE @@ <<n2, m2>> :> FALSE),retiredAt |-> (0 :> {} @@ 1 :> {} @@ 2 :> {}),foldedTok |-> (n1 :> 0 @@ n2 :> 0),present |-> (b1 :> FALSE),mfDeleted |-> {},adopted |-> (0 :> 0 @@ 1 :> 0 @@ 2 :> 0)]),
    ([cursor |-> (n1 :> 0 @@ n2 :> 0),deadTok |-> (b1 :> {}),blobEdges |-> {},shardIndeg |-> (s1 :> (b1 :> 0)),listedTok |-> (n1 :> 0 @@ n2 :> 0),attemptSeq |-> 0,fencePos |-> (n1 :> 0 @@ n2 :> 0),trimBase |-> (n1 :> 0 @@ n2 :> 0),wView |-> (w1 :> 0),foldTok |-> (n1 :> 0 @@ n2 :> 0),nextTok |-> (b1 :> 2),storedTok |-> (b1 :> 0),roundOf |-> (L1 :> 0),tokOf |-> (b1 :> 1),sweepEligible |-> (bp1 :> FALSE),mNs |-> (<<n1, m1>> :> n2 @@ <<n1, m2>> :> n2 @@ <<n2, m1>> :> n2 @@ <<n2, m2>> :> n2),journal |-> (n1 :> <<>> @@ n2 :> <<>>),mRef |-> (<<n1, m1>> :> <<n1, m1>> @@ <<n1, m2>> :> <<n1, m2>> @@ <<n2, m1>> :> <<n2, m1>> @@ <<n2, m2>> :> <<n2, m2>>),gcPhase |-> (L1 :> "idle"),coordFence |-> (n1 :> 0 @@ n2 :> 0),reducerOwner |-> (s1 :> L1),mEntries |-> (<<n1, m1>> :> (p1 :> b1) @@ <<n1, m2>> :> (p1 :> b1) @@ <<n2, m1>> :> (p1 :> "noblob") @@ <<n2, m2>> :> (p1 :> "noblob")),attViewable |-> (0 :> {} @@ 1 :> {} @@ 2 :> {}),retired |-> {},gcRound |-> 0,blobIndeg |-> (b1 :> 0),mPrefix |-> (<<n1, m1>> :> bp1 @@ <<n1, m2>> :> bp1 @@ <<n2, m1>> :> bp1 @@ <<n2, m2>> :> bp1),extraShared |-> {},owner |-> (<<n1, m1>> :> "none" @@ <<n1, m2>> :> "none" @@ <<n2, m1>> :> "none" @@ <<n2, m2>> :> "none"),foldSeal |-> (0 :> [foldedCursor |-> (n1 :> 0 @@ n2 :> 0), classified |-> {}] @@ 1 :> [foldedCursor |-> (n1 :> 0 @@ n2 :> 0), classified |-> {}] @@ 2 :> [foldedCursor |-> (n1 :> 0 @@ n2 :> 0), classified |-> {}]),prevFencePos |-> (n1 :> 0 @@ n2 :> 0),sealAt |-> (0 :> {} @@ 1 :> {} @@ 2 :> {}),everEdged |-> {<<n1, m1>>, <<n1, m2>>},fenceVersion |-> (0 :> (n1 :> 0 @@ n2 :> 0) @@ 1 :> (n1 :> 0 @@ n2 :> 0) @@ 2 :> (n1 :> 0 @@ n2 :> 0)),mActiveEdges |-> (<<n1, m1>> :> (p1 :> "noblob") @@ <<n1, m2>> :> (p1 :> "noblob") @@ <<n2, m1>> :> (p1 :> "noblob") @@ <<n2, m2>> :> (p1 :> "noblob")),completionSeal |-> (0 :> [fenced |-> {}, rechecked |-> {}, deleted |-> {}, adoptable |-> FALSE] @@ 1 :> [fenced |-> {}, rechecked |-> {}, deleted |-> {}, adoptable |-> FALSE] @@ 2 :> [fenced |-> {}, rechecked |-> {}, deleted |-> {}, adoptable |-> FALSE]),mfCleanup |-> {},inflight |-> {},mBody |-> (<<n1, m1>> :> TRUE @@ <<n1, m2>> :> TRUE @@ <<n2, m1>> :> FALSE @@ <<n2, m2>> :> FALSE),retiredAt |-> (0 :> {} @@ 1 :> {} @@ 2 :> {}),foldedTok |-> (n1 :> 0 @@ n2 :> 0),present |-> (b1 :> TRUE),mfDeleted |-> {},adopted |-> (0 :> 0 @@ 1 :> 0 @@ 2 :> 0)]),
    ([cursor |-> (n1 :> 0 @@ n2 :> 0),deadTok |-> (b1 :> {}),blobEdges |-> {},shardIndeg |-> (s1 :> (b1 :> 0)),listedTok |-> (n1 :> 0 @@ n2 :> 0),attemptSeq |-> 0,fencePos |-> (n1 :> 0 @@ n2 :> 0),trimBase |-> (n1 :> 0 @@ n2 :> 0),wView |-> (w1 :> 0),foldTok |-> (n1 :> 0 @@ n2 :> 0),nextTok |-> (b1 :> 2),storedTok |-> (b1 :> 0),roundOf |-> (L1 :> 0),tokOf |-> (b1 :> 1),sweepEligible |-> (bp1 :> FALSE),mNs |-> (<<n1, m1>> :> n2 @@ <<n1, m2>> :> n2 @@ <<n2, m1>> :> n2 @@ <<n2, m2>> :> n2),journal |-> (n1 :> <<[old |-> {}, new |-> {<<n1, m1>>}, ver |-> 1, ref |-> r1]>> @@ n2 :> <<>>),mRef |-> (<<n1, m1>> :> <<n1, m1>> @@ <<n1, m2>> :> <<n1, m2>> @@ <<n2, m1>> :> <<n2, m1>> @@ <<n2, m2>> :> <<n2, m2>>),gcPhase |-> (L1 :> "idle"),coordFence |-> (n1 :> 0 @@ n2 :> 0),reducerOwner |-> (s1 :> L1),mEntries |-> (<<n1, m1>> :> (p1 :> b1) @@ <<n1, m2>> :> (p1 :> b1) @@ <<n2, m1>> :> (p1 :> "noblob") @@ <<n2, m2>> :> (p1 :> "noblob")),attViewable |-> (0 :> {} @@ 1 :> {} @@ 2 :> {}),retired |-> {},gcRound |-> 0,blobIndeg |-> (b1 :> 0),mPrefix |-> (<<n1, m1>> :> bp1 @@ <<n1, m2>> :> bp1 @@ <<n2, m1>> :> bp1 @@ <<n2, m2>> :> bp1),extraShared |-> {},owner |-> (<<n1, m1>> :> r1 @@ <<n1, m2>> :> "none" @@ <<n2, m1>> :> "none" @@ <<n2, m2>> :> "none"),foldSeal |-> (0 :> [foldedCursor |-> (n1 :> 0 @@ n2 :> 0), classified |-> {}] @@ 1 :> [foldedCursor |-> (n1 :> 0 @@ n2 :> 0), classified |-> {}] @@ 2 :> [foldedCursor |-> (n1 :> 0 @@ n2 :> 0), classified |-> {}]),prevFencePos |-> (n1 :> 0 @@ n2 :> 0),sealAt |-> (0 :> {} @@ 1 :> {} @@ 2 :> {}),everEdged |-> {<<n1, m1>>, <<n1, m2>>},fenceVersion |-> (0 :> (n1 :> 0 @@ n2 :> 0) @@ 1 :> (n1 :> 0 @@ n2 :> 0) @@ 2 :> (n1 :> 0 @@ n2 :> 0)),mActiveEdges |-> (<<n1, m1>> :> (p1 :> "noblob") @@ <<n1, m2>> :> (p1 :> "noblob") @@ <<n2, m1>> :> (p1 :> "noblob") @@ <<n2, m2>> :> (p1 :> "noblob")),completionSeal |-> (0 :> [fenced |-> {}, rechecked |-> {}, deleted |-> {}, adoptable |-> FALSE] @@ 1 :> [fenced |-> {}, rechecked |-> {}, deleted |-> {}, adoptable |-> FALSE] @@ 2 :> [fenced |-> {}, rechecked |-> {}, deleted |-> {}, adoptable |-> FALSE]),mfCleanup |-> {},inflight |-> {},mBody |-> (<<n1, m1>> :> TRUE @@ <<n1, m2>> :> TRUE @@ <<n2, m1>> :> FALSE @@ <<n2, m2>> :> FALSE),retiredAt |-> (0 :> {} @@ 1 :> {} @@ 2 :> {}),foldedTok |-> (n1 :> 0 @@ n2 :> 0),present |-> (b1 :> TRUE),mfDeleted |-> {},adopted |-> (0 :> 0 @@ 1 :> 0 @@ 2 :> 0)]),
    ([cursor |-> (n1 :> 0 @@ n2 :> 0),deadTok |-> (b1 :> {}),blobEdges |-> {},shardIndeg |-> (s1 :> (b1 :> 0)),listedTok |-> (n1 :> 0 @@ n2 :> 0),attemptSeq |-> 0,fencePos |-> (n1 :> 0 @@ n2 :> 0),trimBase |-> (n1 :> 0 @@ n2 :> 0),wView |-> (w1 :> 0),foldTok |-> (n1 :> 0 @@ n2 :> 0),nextTok |-> (b1 :> 2),storedTok |-> (b1 :> 0),roundOf |-> (L1 :> 1),tokOf |-> (b1 :> 1),sweepEligible |-> (bp1 :> FALSE),mNs |-> (<<n1, m1>> :> n2 @@ <<n1, m2>> :> n2 @@ <<n2, m1>> :> n2 @@ <<n2, m2>> :> n2),journal |-> (n1 :> <<[old |-> {}, new |-> {<<n1, m1>>}, ver |-> 1, ref |-> r1]>> @@ n2 :> <<>>),mRef |-> (<<n1, m1>> :> <<n1, m1>> @@ <<n1, m2>> :> <<n1, m2>> @@ <<n2, m1>> :> <<n2, m1>> @@ <<n2, m2>> :> <<n2, m2>>),gcPhase |-> (L1 :> "retiring"),coordFence |-> (n1 :> 0 @@ n2 :> 0),reducerOwner |-> (s1 :> L1),mEntries |-> (<<n1, m1>> :> (p1 :> b1) @@ <<n1, m2>> :> (p1 :> b1) @@ <<n2, m1>> :> (p1 :> "noblob") @@ <<n2, m2>> :> (p1 :> "noblob")),attViewable |-> (0 :> {} @@ 1 :> {} @@ 2 :> {}),retired |-> {},gcRound |-> 1,blobIndeg |-> (b1 :> 0),mPrefix |-> (<<n1, m1>> :> bp1 @@ <<n1, m2>> :> bp1 @@ <<n2, m1>> :> bp1 @@ <<n2, m2>> :> bp1),extraShared |-> {},owner |-> (<<n1, m1>> :> r1 @@ <<n1, m2>> :> "none" @@ <<n2, m1>> :> "none" @@ <<n2, m2>> :> "none"),foldSeal |-> (0 :> [foldedCursor |-> (n1 :> 0 @@ n2 :> 0), classified |-> {}] @@ 1 :> [foldedCursor |-> (n1 :> 0 @@ n2 :> 0), classified |-> {}] @@ 2 :> [foldedCursor |-> (n1 :> 0 @@ n2 :> 0), classified |-> {}]),prevFencePos |-> (n1 :> 0 @@ n2 :> 0),sealAt |-> (0 :> {} @@ 1 :> {} @@ 2 :> {}),everEdged |-> {<<n1, m1>>, <<n1, m2>>},fenceVersion |-> (0 :> (n1 :> 0 @@ n2 :> 0) @@ 1 :> (n1 :> 0 @@ n2 :> 0) @@ 2 :> (n1 :> 0 @@ n2 :> 0)),mActiveEdges |-> (<<n1, m1>> :> (p1 :> "noblob") @@ <<n1, m2>> :> (p1 :> "noblob") @@ <<n2, m1>> :> (p1 :> "noblob") @@ <<n2, m2>> :> (p1 :> "noblob")),completionSeal |-> (0 :> [fenced |-> {}, rechecked |-> {}, deleted |-> {}, adoptable |-> FALSE] @@ 1 :> [fenced |-> {}, rechecked |-> {}, deleted |-> {}, adoptable |-> FALSE] @@ 2 :> [fenced |-> {}, rechecked |-> {}, deleted |-> {}, adoptable |-> FALSE]),mfCleanup |-> {},inflight |-> {},mBody |-> (<<n1, m1>> :> TRUE @@ <<n1, m2>> :> TRUE @@ <<n2, m1>> :> FALSE @@ <<n2, m2>> :> FALSE),retiredAt |-> (0 :> {} @@ 1 :> {} @@ 2 :> {}),foldedTok |-> (n1 :> 0 @@ n2 :> 0),present |-> (b1 :> TRUE),mfDeleted |-> {},adopted |-> (0 :> 0 @@ 1 :> 0 @@ 2 :> 0)]),
    ([cursor |-> (n1 :> 1 @@ n2 :> 0),deadTok |-> (b1 :> {}),blobEdges |-> {},shardIndeg |-> (s1 :> (b1 :> 0)),listedTok |-> (n1 :> 0 @@ n2 :> 0),attemptSeq |-> 0,fencePos |-> (n1 :> 0 @@ n2 :> 0),trimBase |-> (n1 :> 0 @@ n2 :> 0),wView |-> (w1 :> 0),foldTok |-> (n1 :> 0 @@ n2 :> 0),nextTok |-> (b1 :> 2),storedTok |-> (b1 :> 0),roundOf |-> (L1 :> 1),tokOf |-> (b1 :> 1),sweepEligible |-> (bp1 :> FALSE),mNs |-> (<<n1, m1>> :> n2 @@ <<n1, m2>> :> n2 @@ <<n2, m1>> :> n2 @@ <<n2, m2>> :> n2),journal |-> (n1 :> <<[old |-> {}, new |-> {<<n1, m1>>}, ver |-> 1, ref |-> r1]>> @@ n2 :> <<>>),mRef |-> (<<n1, m1>> :> <<n1, m1>> @@ <<n1, m2>> :> <<n1, m2>> @@ <<n2, m1>> :> <<n2, m1>> @@ <<n2, m2>> :> <<n2, m2>>),gcPhase |-> (L1 :> "retiring"),coordFence |-> (n1 :> 0 @@ n2 :> 0),reducerOwner |-> (s1 :> L1),mEntries |-> (<<n1, m1>> :> (p1 :> b1) @@ <<n1, m2>> :> (p1 :> b1) @@ <<n2, m1>> :> (p1 :> "noblob") @@ <<n2, m2>> :> (p1 :> "noblob")),attViewable |-> (0 :> {} @@ 1 :> {} @@ 2 :> {}),retired |-> {},gcRound |-> 1,blobIndeg |-> (b1 :> 0),mPrefix |-> (<<n1, m1>> :> bp1 @@ <<n1, m2>> :> bp1 @@ <<n2, m1>> :> bp1 @@ <<n2, m2>> :> bp1),extraShared |-> {},owner |-> (<<n1, m1>> :> r1 @@ <<n1, m2>> :> "none" @@ <<n2, m1>> :> "none" @@ <<n2, m2>> :> "none"),foldSeal |-> (0 :> [foldedCursor |-> (n1 :> 0 @@ n2 :> 0), classified |-> {}] @@ 1 :> [foldedCursor |-> (n1 :> 1 @@ n2 :> 0), classified |-> {}] @@ 2 :> [foldedCursor |-> (n1 :> 0 @@ n2 :> 0), classified |-> {}]),prevFencePos |-> (n1 :> 0 @@ n2 :> 0),sealAt |-> (0 :> {} @@ 1 :> {} @@ 2 :> {}),everEdged |-> {<<n1, m1>>, <<n1, m2>>},fenceVersion |-> (0 :> (n1 :> 0 @@ n2 :> 0) @@ 1 :> (n1 :> 0 @@ n2 :> 0) @@ 2 :> (n1 :> 0 @@ n2 :> 0)),mActiveEdges |-> (<<n1, m1>> :> (p1 :> "noblob") @@ <<n1, m2>> :> (p1 :> "noblob") @@ <<n2, m1>> :> (p1 :> "noblob") @@ <<n2, m2>> :> (p1 :> "noblob")),completionSeal |-> (0 :> [fenced |-> {}, rechecked |-> {}, deleted |-> {}, adoptable |-> FALSE] @@ 1 :> [fenced |-> {}, rechecked |-> {}, deleted |-> {}, adoptable |-> FALSE] @@ 2 :> [fenced |-> {}, rechecked |-> {}, deleted |-> {}, adoptable |-> FALSE]),mfCleanup |-> {},inflight |-> {},mBody |-> (<<n1, m1>> :> TRUE @@ <<n1, m2>> :> TRUE @@ <<n2, m1>> :> FALSE @@ <<n2, m2>> :> FALSE),retiredAt |-> (0 :> {} @@ 1 :> {} @@ 2 :> {}),foldedTok |-> (n1 :> 0 @@ n2 :> 0),present |-> (b1 :> TRUE),mfDeleted |-> {},adopted |-> (0 :> 0 @@ 1 :> 0 @@ 2 :> 0)]),
    ([cursor |-> (n1 :> 1 @@ n2 :> 0),deadTok |-> (b1 :> {}),blobEdges |-> {},shardIndeg |-> (s1 :> (b1 :> 0)),listedTok |-> (n1 :> 0 @@ n2 :> 0),attemptSeq |-> 0,fencePos |-> (n1 :> 0 @@ n2 :> 0),trimBase |-> (n1 :> 0 @@ n2 :> 0),wView |-> (w1 :> 0),foldTok |-> (n1 :> 0 @@ n2 :> 0),nextTok |-> (b1 :> 2),storedTok |-> (b1 :> 0),roundOf |-> (L1 :> 1),tokOf |-> (b1 :> 1),sweepEligible |-> (bp1 :> FALSE),mNs |-> (<<n1, m1>> :> n2 @@ <<n1, m2>> :> n2 @@ <<n2, m1>> :> n2 @@ <<n2, m2>> :> n2),journal |-> (n1 :> <<[old |-> {}, new |-> {<<n1, m1>>}, ver |-> 1, ref |-> r1]>> @@ n2 :> <<>>),mRef |-> (<<n1, m1>> :> <<n1, m1>> @@ <<n1, m2>> :> <<n1, m2>> @@ <<n2, m1>> :> <<n2, m1>> @@ <<n2, m2>> :> <<n2, m2>>),gcPhase |-> (L1 :> "retiring"),coordFence |-> (n1 :> 0 @@ n2 :> 0),reducerOwner |-> (s1 :> L1),mEntries |-> (<<n1, m1>> :> (p1 :> b1) @@ <<n1, m2>> :> (p1 :> b1) @@ <<n2, m1>> :> (p1 :> "noblob") @@ <<n2, m2>> :> (p1 :> "noblob")),attViewable |-> (0 :> {} @@ 1 :> {} @@ 2 :> {}),retired |-> {[b |-> b1, t |-> 1, r |-> 1]},gcRound |-> 1,blobIndeg |-> (b1 :> 0),mPrefix |-> (<<n1, m1>> :> bp1 @@ <<n1, m2>> :> bp1 @@ <<n2, m1>> :> bp1 @@ <<n2, m2>> :> bp1),extraShared |-> {},owner |-> (<<n1, m1>> :> r1 @@ <<n1, m2>> :> "none" @@ <<n2, m1>> :> "none" @@ <<n2, m2>> :> "none"),foldSeal |-> (0 :> [foldedCursor |-> (n1 :> 0 @@ n2 :> 0), classified |-> {}] @@ 1 :> [foldedCursor |-> (n1 :> 1 @@ n2 :> 0), classified |-> {}] @@ 2 :> [foldedCursor |-> (n1 :> 0 @@ n2 :> 0), classified |-> {}]),prevFencePos |-> (n1 :> 0 @@ n2 :> 0),sealAt |-> (0 :> {} @@ 1 :> {} @@ 2 :> {}),everEdged |-> {<<n1, m1>>, <<n1, m2>>},fenceVersion |-> (0 :> (n1 :> 0 @@ n2 :> 0) @@ 1 :> (n1 :> 0 @@ n2 :> 0) @@ 2 :> (n1 :> 0 @@ n2 :> 0)),mActiveEdges |-> (<<n1, m1>> :> (p1 :> "noblob") @@ <<n1, m2>> :> (p1 :> "noblob") @@ <<n2, m1>> :> (p1 :> "noblob") @@ <<n2, m2>> :> (p1 :> "noblob")),completionSeal |-> (0 :> [fenced |-> {}, rechecked |-> {}, deleted |-> {}, adoptable |-> FALSE] @@ 1 :> [fenced |-> {}, rechecked |-> {}, deleted |-> {}, adoptable |-> FALSE] @@ 2 :> [fenced |-> {}, rechecked |-> {}, deleted |-> {}, adoptable |-> FALSE]),mfCleanup |-> {},inflight |-> {},mBody |-> (<<n1, m1>> :> TRUE @@ <<n1, m2>> :> TRUE @@ <<n2, m1>> :> FALSE @@ <<n2, m2>> :> FALSE),retiredAt |-> (0 :> {} @@ 1 :> {} @@ 2 :> {}),foldedTok |-> (n1 :> 0 @@ n2 :> 0),present |-> (b1 :> TRUE),mfDeleted |-> {},adopted |-> (0 :> 0 @@ 1 :> 0 @@ 2 :> 0)]),
    ([cursor |-> (n1 :> 1 @@ n2 :> 0),deadTok |-> (b1 :> {}),blobEdges |-> {},shardIndeg |-> (s1 :> (b1 :> 0)),listedTok |-> (n1 :> 0 @@ n2 :> 0),attemptSeq |-> 0,fencePos |-> (n1 :> 0 @@ n2 :> 0),trimBase |-> (n1 :> 0 @@ n2 :> 0),wView |-> (w1 :> 0),foldTok |-> (n1 :> 0 @@ n2 :> 0),nextTok |-> (b1 :> 2),storedTok |-> (b1 :> 0),roundOf |-> (L1 :> 1),tokOf |-> (b1 :> 1),sweepEligible |-> (bp1 :> FALSE),mNs |-> (<<n1, m1>> :> n2 @@ <<n1, m2>> :> n2 @@ <<n2, m1>> :> n2 @@ <<n2, m2>> :> n2),journal |-> (n1 :> <<[old |-> {}, new |-> {<<n1, m1>>}, ver |-> 1, ref |-> r1]>> @@ n2 :> <<>>),mRef |-> (<<n1, m1>> :> <<n1, m1>> @@ <<n1, m2>> :> <<n1, m2>> @@ <<n2, m1>> :> <<n2, m1>> @@ <<n2, m2>> :> <<n2, m2>>),gcPhase |-> (L1 :> "fencing"),coordFence |-> (n1 :> 0 @@ n2 :> 0),reducerOwner |-> (s1 :> L1),mEntries |-> (<<n1, m1>> :> (p1 :> b1) @@ <<n1, m2>> :> (p1 :> b1) @@ <<n2, m1>> :> (p1 :> "noblob") @@ <<n2, m2>> :> (p1 :> "noblob")),attViewable |-> (0 :> {} @@ 1 :> {} @@ 2 :> {}),retired |-> {[b |-> b1, t |-> 1, r |-> 1]},gcRound |-> 1,blobIndeg |-> (b1 :> 0),mPrefix |-> (<<n1, m1>> :> bp1 @@ <<n1, m2>> :> bp1 @@ <<n2, m1>> :> bp1 @@ <<n2, m2>> :> bp1),extraShared |-> {},owner |-> (<<n1, m1>> :> r1 @@ <<n1, m2>> :> "none" @@ <<n2, m1>> :> "none" @@ <<n2, m2>> :> "none"),foldSeal |-> (0 :> [foldedCursor |-> (n1 :> 0 @@ n2 :> 0), classified |-> {}] @@ 1 :> [foldedCursor |-> (n1 :> 1 @@ n2 :> 0), classified |-> {}] @@ 2 :> [foldedCursor |-> (n1 :> 0 @@ n2 :> 0), classified |-> {}]),prevFencePos |-> (n1 :> 0 @@ n2 :> 0),sealAt |-> (0 :> {} @@ 1 :> {} @@ 2 :> {}),everEdged |-> {<<n1, m1>>, <<n1, m2>>},fenceVersion |-> (0 :> (n1 :> 0 @@ n2 :> 0) @@ 1 :> (n1 :> 0 @@ n2 :> 0) @@ 2 :> (n1 :> 0 @@ n2 :> 0)),mActiveEdges |-> (<<n1, m1>> :> (p1 :> "noblob") @@ <<n1, m2>> :> (p1 :> "noblob") @@ <<n2, m1>> :> (p1 :> "noblob") @@ <<n2, m2>> :> (p1 :> "noblob")),completionSeal |-> (0 :> [fenced |-> {}, rechecked |-> {}, deleted |-> {}, adoptable |-> FALSE] @@ 1 :> [fenced |-> {}, rechecked |-> {}, deleted |-> {}, adoptable |-> FALSE] @@ 2 :> [fenced |-> {}, rechecked |-> {}, deleted |-> {}, adoptable |-> FALSE]),mfCleanup |-> {},inflight |-> {},mBody |-> (<<n1, m1>> :> TRUE @@ <<n1, m2>> :> TRUE @@ <<n2, m1>> :> FALSE @@ <<n2, m2>> :> FALSE),retiredAt |-> (0 :> {} @@ 1 :> {} @@ 2 :> {}),foldedTok |-> (n1 :> 0 @@ n2 :> 0),present |-> (b1 :> TRUE),mfDeleted |-> {},adopted |-> (0 :> 0 @@ 1 :> 0 @@ 2 :> 0)]),
    ...
    ([cursor |-> (n1 :> 1 @@ n2 :> 0),deadTok |-> (b1 :> {}),blobEdges |-> {},shardIndeg |-> (s1 :> (b1 :> 0)),listedTok |-> (n1 :> 0 @@ n2 :> 0),attemptSeq |-> 0,fencePos |-> (n1 :> 1 @@ n2 :> 0),trimBase |-> (n1 :> 0 @@ n2 :> 0),wView |-> (w1 :> 0),foldTok |-> (n1 :> 0 @@ n2 :> 0),nextTok |-> (b1 :> 2),storedTok |-> (b1 :> 0),roundOf |-> (L1 :> 1),tokOf |-> (b1 :> 1),sweepEligible |-> (bp1 :> FALSE),mNs |-> (<<n1, m1>> :> n2 @@ <<n1, m2>> :> n2 @@ <<n2, m1>> :> n2 @@ <<n2, m2>> :> n2),journal |-> (n1 :> <<[old |-> {}, new |-> {<<n1, m1>>}, ver |-> 1, ref |-> r1]>> @@ n2 :> <<>>),mRef |-> (<<n1, m1>> :> <<n1, m1>> @@ <<n1, m2>> :> <<n1, m2>> @@ <<n2, m1>> :> <<n2, m1>> @@ <<n2, m2>> :> <<n2, m2>>),gcPhase |-> (L1 :> "fenced"),coordFence |-> (n1 :> 0 @@ n2 :> 0),reducerOwner |-> (s1 :> L1),mEntries |-> (<<n1, m1>> :> (p1 :> b1) @@ <<n1, m2>> :> (p1 :> b1) @@ <<n2, m1>> :> (p1 :> "noblob") @@ <<n2, m2>> :> (p1 :> "noblob")),attViewable |-> (0 :> {} @@ 1 :> {} @@ 2 :> {}),retired |-> {[b |-> b1, t |-> 1, r |-> 1]},gcRound |-> 1,blobIndeg |-> (b1 :> 0),mPrefix |-> (<<n1, m1>> :> bp1 @@ <<n1, m2>> :> bp1 @@ <<n2, m1>> :> bp1 @@ <<n2, m2>> :> bp1),extraShared |-> {},owner |-> (<<n1, m1>> :> r1 @@ <<n1, m2>> :> "none" @@ <<n2, m1>> :> "none" @@ <<n2, m2>> :> "none"),foldSeal |-> (0 :> [foldedCursor |-> (n1 :> 0 @@ n2 :> 0), classified |-> {}] @@ 1 :> [foldedCursor |-> (n1 :> 1 @@ n2 :> 0), classified |-> {}] @@ 2 :> [foldedCursor |-> (n1 :> 0 @@ n2 :> 0), classified |-> {}]),prevFencePos |-> (n1 :> 0 @@ n2 :> 0),sealAt |-> (0 :> {} @@ 1 :> {} @@ 2 :> {}),everEdged |-> {<<n1, m1>>, <<n1, m2>>},fenceVersion |-> (0 :> (n1 :> 0 @@ n2 :> 0) @@ 1 :> (n1 :> 1 @@ n2 :> 1) @@ 2 :> (n1 :> 0 @@ n2 :> 0)),mActiveEdges |-> (<<n1, m1>> :> (p1 :> "noblob") @@ <<n1, m2>> :> (p1 :> "noblob") @@ <<n2, m1>> :> (p1 :> "noblob") @@ <<n2, m2>> :> (p1 :> "noblob")),completionSeal |-> (0 :> [fenced |-> {}, rechecked |-> {}, deleted |-> {}, adoptable |-> FALSE] @@ 1 :> [fenced |-> {n1, n2}, rechecked |-> {}, deleted |-> {}, adoptable |-> FALSE] @@ 2 :> [fenced |-> {}, rechecked |-> {}, deleted |-> {}, adoptable |-> FALSE]),mfCleanup |-> {},inflight |-> {},mBody |-> (<<n1, m1>> :> TRUE @@ <<n1, m2>> :> TRUE @@ <<n2, m1>> :> FALSE @@ <<n2, m2>> :> FALSE),retiredAt |-> (0 :> {} @@ 1 :> {} @@ 2 :> {}),foldedTok |-> (n1 :> 0 @@ n2 :> 0),present |-> (b1 :> TRUE),mfDeleted |-> {},adopted |-> (0 :> 0 @@ 1 :> 0 @@ 2 :> 0)]),
    ([cursor |-> (n1 :> 1 @@ n2 :> 0),deadTok |-> (b1 :> {}),blobEdges |-> {},shardIndeg |-> (s1 :> (b1 :> 0)),listedTok |-> (n1 :> 0 @@ n2 :> 0),attemptSeq |-> 0,fencePos |-> (n1 :> 1 @@ n2 :> 0),trimBase |-> (n1 :> 0 @@ n2 :> 0),wView |-> (w1 :> 0),foldTok |-> (n1 :> 0 @@ n2 :> 0),nextTok |-> (b1 :> 2),storedTok |-> (b1 :> 0),roundOf |-> (L1 :> 1),tokOf |-> (b1 :> 1),sweepEligible |-> (bp1 :> FALSE),mNs |-> (<<n1, m1>> :> n2 @@ <<n1, m2>> :> n2 @@ <<n2, m1>> :> n2 @@ <<n2, m2>> :> n2),journal |-> (n1 :> <<[old |-> {}, new |-> {<<n1, m1>>}, ver |-> 1, ref |-> r1]>> @@ n2 :> <<>>),mRef |-> (<<n1, m1>> :> <<n1, m1>> @@ <<n1, m2>> :> <<n1, m2>> @@ <<n2, m1>> :> <<n2, m1>> @@ <<n2, m2>> :> <<n2, m2>>),gcPhase |-> (L1 :> "fenced"),coordFence |-> (n1 :> 0 @@ n2 :> 0),reducerOwner |-> (s1 :> L1),mEntries |-> (<<n1, m1>> :> (p1 :> b1) @@ <<n1, m2>> :> (p1 :> b1) @@ <<n2, m1>> :> (p1 :> "noblob") @@ <<n2, m2>> :> (p1 :> "noblob")),attViewable |-> (0 :> {} @@ 1 :> {} @@ 2 :> {}),retired |-> {[b |-> b1, t |-> 1, r |-> 1]},gcRound |-> 1,blobIndeg |-> (b1 :> 0),mPrefix |-> (<<n1, m1>> :> bp1 @@ <<n1, m2>> :> bp1 @@ <<n2, m1>> :> bp1 @@ <<n2, m2>> :> bp1),extraShared |-> {},owner |-> (<<n1, m1>> :> r1 @@ <<n1, m2>> :> "none" @@ <<n2, m1>> :> "none" @@ <<n2, m2>> :> "none"),foldSeal |-> (0 :> [foldedCursor |-> (n1 :> 0 @@ n2 :> 0), classified |-> {}] @@ 1 :> [foldedCursor |-> (n1 :> 1 @@ n2 :> 0), classified |-> {}] @@ 2 :> [foldedCursor |-> (n1 :> 0 @@ n2 :> 0), classified |-> {}]),prevFencePos |-> (n1 :> 0 @@ n2 :> 0),sealAt |-> (0 :> {} @@ 1 :> {} @@ 2 :> {}),everEdged |-> {<<n1, m1>>, <<n1, m2>>},fenceVersion |-> (0 :> (n1 :> 0 @@ n2 :> 0) @@ 1 :> (n1 :> 1 @@ n2 :> 1) @@ 2 :> (n1 :> 0 @@ n2 :> 0)),mActiveEdges |-> (<<n1, m1>> :> (p1 :> "noblob") @@ <<n1, m2>> :> (p1 :> "noblob") @@ <<n2, m1>> :> (p1 :> "noblob") @@ <<n2, m2>> :> (p1 :> "noblob")),completionSeal |-> (0 :> [fenced |-> {}, rechecked |-> {}, deleted |-> {}, adoptable |-> FALSE] @@ 1 :> [fenced |-> {n1, n2}, rechecked |-> {}, deleted |-> {b1}, adoptable |-> FALSE] @@ 2 :> [fenced |-> {}, rechecked |-> {}, deleted |-> {}, adoptable |-> FALSE]),mfCleanup |-> {},inflight |-> {[b |-> b1, t |-> 1]},mBody |-> (<<n1, m1>> :> TRUE @@ <<n1, m2>> :> TRUE @@ <<n2, m1>> :> FALSE @@ <<n2, m2>> :> FALSE),retiredAt |-> (0 :> {} @@ 1 :> {} @@ 2 :> {}),foldedTok |-> (n1 :> 0 @@ n2 :> 0),present |-> (b1 :> TRUE),mfDeleted |-> {},adopted |-> (0 :> 0 @@ 1 :> 0 @@ 2 :> 0)]),
    ([cursor |-> (n1 :> 1 @@ n2 :> 0),deadTok |-> (b1 :> {1}),blobEdges |-> {},shardIndeg |-> (s1 :> (b1 :> 0)),listedTok |-> (n1 :> 0 @@ n2 :> 0),attemptSeq |-> 0,fencePos |-> (n1 :> 1 @@ n2 :> 0),trimBase |-> (n1 :> 0 @@ n2 :> 0),wView |-> (w1 :> 0),foldTok |-> (n1 :> 0 @@ n2 :> 0),nextTok |-> (b1 :> 2),storedTok |-> (b1 :> 0),roundOf |-> (L1 :> 1),tokOf |-> (b1 :> 1),sweepEligible |-> (bp1 :> FALSE),mNs |-> (<<n1, m1>> :> n2 @@ <<n1, m2>> :> n2 @@ <<n2, m1>> :> n2 @@ <<n2, m2>> :> n2),journal |-> (n1 :> <<[old |-> {}, new |-> {<<n1, m1>>}, ver |-> 1, ref |-> r1]>> @@ n2 :> <<>>),mRef |-> (<<n1, m1>> :> <<n1, m1>> @@ <<n1, m2>> :> <<n1, m2>> @@ <<n2, m1>> :> <<n2, m1>> @@ <<n2, m2>> :> <<n2, m2>>),gcPhase |-> (L1 :> "fenced"),coordFence |-> (n1 :> 0 @@ n2 :> 0),reducerOwner |-> (s1 :> L1),mEntries |-> (<<n1, m1>> :> (p1 :> b1) @@ <<n1, m2>> :> (p1 :> b1) @@ <<n2, m1>> :> (p1 :> "noblob") @@ <<n2, m2>> :> (p1 :> "noblob")),attViewable |-> (0 :> {} @@ 1 :> {} @@ 2 :> {}),retired |-> {},gcRound |-> 1,blobIndeg |-> (b1 :> 0),mPrefix |-> (<<n1, m1>> :> bp1 @@ <<n1, m2>> :> bp1 @@ <<n2, m1>> :> bp1 @@ <<n2, m2>> :> bp1),extraShared |-> {},owner |-> (<<n1, m1>> :> r1 @@ <<n1, m2>> :> "none" @@ <<n2, m1>> :> "none" @@ <<n2, m2>> :> "none"),foldSeal |-> (0 :> [foldedCursor |-> (n1 :> 0 @@ n2 :> 0), classified |-> {}] @@ 1 :> [foldedCursor |-> (n1 :> 1 @@ n2 :> 0), classified |-> {}] @@ 2 :> [foldedCursor |-> (n1 :> 0 @@ n2 :> 0), classified |-> {}]),prevFencePos |-> (n1 :> 0 @@ n2 :> 0),sealAt |-> (0 :> {} @@ 1 :> {} @@ 2 :> {}),everEdged |-> {<<n1, m1>>, <<n1, m2>>},fenceVersion |-> (0 :> (n1 :> 0 @@ n2 :> 0) @@ 1 :> (n1 :> 1 @@ n2 :> 1) @@ 2 :> (n1 :> 0 @@ n2 :> 0)),mActiveEdges |-> (<<n1, m1>> :> (p1 :> "noblob") @@ <<n1, m2>> :> (p1 :> "noblob") @@ <<n2, m1>> :> (p1 :> "noblob") @@ <<n2, m2>> :> (p1 :> "noblob")),completionSeal |-> (0 :> [fenced |-> {}, rechecked |-> {}, deleted |-> {}, adoptable |-> FALSE] @@ 1 :> [fenced |-> {n1, n2}, rechecked |-> {}, deleted |-> {b1}, adoptable |-> FALSE] @@ 2 :> [fenced |-> {}, rechecked |-> {}, deleted |-> {}, adoptable |-> FALSE]),mfCleanup |-> {},inflight |-> {},mBody |-> (<<n1, m1>> :> TRUE @@ <<n1, m2>> :> TRUE @@ <<n2, m1>> :> FALSE @@ <<n2, m2>> :> FALSE),retiredAt |-> (0 :> {} @@ 1 :> {} @@ 2 :> {}),foldedTok |-> (n1 :> 0 @@ n2 :> 0),present |-> (b1 :> FALSE),mfDeleted |-> {},adopted |-> (0 :> 0 @@ 1 :> 0 @@ 2 :> 0)])
    >>
----
...
---- CONFIG CaGcRootLocalPartManifestCore_TTrace_1785658267 ----
CONSTANTS
    Namespaces = { n1 , n2 }
    Writers = { w1 }
    Leaders = { L1 }
...
ALIAS
    _expression
=============================================================================
\* Generated on Sun Aug 02 10:11:18 CEST 2026