---- MODULE CaGcRootLocalPartManifestCore_TTrace_1785658874 ----
...
\* to `JsonSerialize`. For example, a sub-sequence of _TETrace.
    \* ASSUME
    \*     LET J == INSTANCE Json
    \*         IN J!JsonSerialize("CaGcRootLocalPartManifestCore_TTrace_1785658874.json", _TETrace)
...
\*
\*trace == IODeserialize("CaGcRootLocalPartManifestCore_TTrace_1785658874.bin", TRUE)
\*
\*=============================================================================
\*
...
---- CONFIG CaGcRootLocalPartManifestCore_TTrace_1785658874 ----
CONSTANTS
    Namespaces = { n1 }
    Writers = { w1 }
    Leaders = { L1 }
...
ALIAS
    _expression
=============================================================================
\* Generated on Sun Aug 02 10:21:15 CEST 2026