---- MODULE CaGcRootLocalPartManifestCore_TTrace_1785658995 ----
...
\* to `JsonSerialize`. For example, a sub-sequence of _TETrace.
    \* ASSUME
    \*     LET J == INSTANCE Json
    \*         IN J!JsonSerialize("CaGcRootLocalPartManifestCore_TTrace_1785658995.json", _TETrace)
...
\*
\*trace == IODeserialize("CaGcRootLocalPartManifestCore_TTrace_1785658995.bin", TRUE)
\*
\*=============================================================================
\*
...
---- CONFIG CaGcRootLocalPartManifestCore_TTrace_1785658995 ----
CONSTANTS
    Namespaces = { n1 }
    Writers = { w1 }
    Leaders = { L1 }
