---- MODULE CaGcRoundDeferCore_TTrace_1785722583 ----
...
\* to `JsonSerialize`. For example, a sub-sequence of _TETrace.
    \* ASSUME
    \*     LET J == INSTANCE Json
    \*         IN J!JsonSerialize("CaGcRoundDeferCore_TTrace_1785722583.json", _TETrace)
...
\*
\*trace == IODeserialize("CaGcRoundDeferCore_TTrace_1785722583.bin", TRUE)
\*
\*=============================================================================
\*
...
---- CONFIG CaGcRoundDeferCore_TTrace_1785722583 ----
CONSTANTS
    Writers = { w1 , w2 }
    Blobs = { b1 }
    MaxRound = 4
...
ALIAS
    _expression
=============================================================================
\* Generated on Mon Aug 03 04:03:04 CEST 2026