---- MODULE CaGcRootLocalPartManifestCore_TTrace_1785652100 ----
...
_inv ==
    ~(
        ...
        /\
        mEntries = ((<<n1, m1>> :> (p1 :> b2) @@ <<n1, m2>> :> (p1 :> b2)))
        /\
        attViewable = ((0 :> {} @@ 1 :> {} @@ 2 :> {}))
        /\
        retired = ({})
...
\* to `JsonSerialize`. For example, a sub-sequence of _TETrace.
    \* ASSUME
    \*     LET J == INSTANCE Json
    \*         IN J!JsonSerialize("CaGcRootLocalPartManifestCore_TTrace_1785652100.json", _TETrace)
...
\*
\*trace == IODeserialize("CaGcRootLocalPartManifestCore_TTrace_1785652100.bin", TRUE)
\*
\*=============================================================================
\*
...
---- CONFIG CaGcRootLocalPartManifestCore_TTrace_1785652100 ----
CONSTANTS
    Namespaces = { n1 }
    Writers = { w1 }
    Leaders = { L1 , L2 }
...
ALIAS
    _expression
=============================================================================
\* Generated on Sun Aug 02 08:28:22 CEST 2026