---- MODULE CaGcAckFloorCore_TTrace_1785648262 ----
...
\* to `JsonSerialize`. For example, a sub-sequence of _TETrace.
    \* ASSUME
    \*     LET J == INSTANCE Json
    \*         IN J!JsonSerialize("CaGcAckFloorCore_TTrace_1785648262.json", _TETrace)
...
\*
\*trace == IODeserialize("CaGcAckFloorCore_TTrace_1785648262.bin", TRUE)
\*
\*=============================================================================
\*
...
---- CONFIG CaGcAckFloorCore_TTrace_1785648262 ----
CONSTANTS
    Writers = { w1 , w2 }
    Blobs = { b1 }
    MaxRound = 4
    MaxTok = 4
    SabotageIgnoreAckFloor = TRUE
...
ALIAS
    _expression
=============================================================================
\* Generated on Sun Aug 02 07:24:23 CEST 2026