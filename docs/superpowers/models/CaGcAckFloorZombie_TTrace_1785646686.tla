---- MODULE CaGcAckFloorZombie_TTrace_1785646686 ----
...
\* to `JsonSerialize`. For example, a sub-sequence of _TETrace.
    \* ASSUME
    \*     LET J == INSTANCE Json
    \*         IN J!JsonSerialize("CaGcAckFloorZombie_TTrace_1785646686.json", _TETrace)
...
\*
\*trace == IODeserialize("CaGcAckFloorZombie_TTrace_1785646686.bin", TRUE)
\*
\*=============================================================================
\*
...
---- CONFIG CaGcAckFloorZombie_TTrace_1785646686 ----
CONSTANTS
    Writers = { w1 , w2 }
    Leaders = { l1 , l2 }
    Blobs = { b1 }
...
ALIAS
    _expression
=============================================================================
\* Generated on Sun Aug 02 06:58:12 CEST 2026