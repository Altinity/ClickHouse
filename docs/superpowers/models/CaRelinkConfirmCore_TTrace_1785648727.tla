---- MODULE CaRelinkConfirmCore_TTrace_1785648727 ----
...
\* to `JsonSerialize`. For example, a sub-sequence of _TETrace.
    \* ASSUME
    \*     LET J == INSTANCE Json
    \*         IN J!JsonSerialize("CaRelinkConfirmCore_TTrace_1785648727.json", _TETrace)
...
\*
\*trace == IODeserialize("CaRelinkConfirmCore_TTrace_1785648727.bin", TRUE)
\*
\*=============================================================================
\*
...
trace == 
    ...
    ([cursor |-> (r1 :> 0 @@ "ns_s" :> 0),sawConfirmNo |-> FALSE,rAnswer |-> (r1 :> "none"),sCacheRef |-> "m2",sLeader |-> FALSE,sPoison |-> FALSE,sDurableRef |-> "m2",sTarget |-> "m2",condemned |-> {},rState |-> (r1 :> "init"),nextId |-> 2,journal |-> {[id |-> 1, ns |-> "ns_s", blob |-> "b1", src |-> "s_m1", op |-> "del"]},sPending |-> FALSE,round |-> 0,gcPhase |-> "idle",sFence |-> TRUE,sawConfirmUnk |-> FALSE,rDurableBefore |-> (r1 :> FALSE),pendingDelete |-> {},present |-> [b1 |-> TRUE],folded |-> {[src |-> "s_m1", b |-> "b1"]},holes |-> 0]),
    ([cursor |-> (r1 :> 0 @@ "ns_s" :> 1),sawConfirmNo |-> FALSE,rAnswer |-> (r1 :> "none"),sCacheRef |-> "m2",sLeader |-> FALSE,sPoison |-> FALSE,sDurableRef |-> "m2",sTarget |-> "m2",condemned |-> {},rState |-> (r1 :> "init"),nextId |-> 2,journal |-> {[id |-> 1, ns |-> "ns_s", blob |-> "b1", src |-> "s_m1", op |-> "del"]},sPending |-> FALSE,round |-> 0,gcPhase |-> "folded",sFence |-> TRUE,sawConfirmUnk |-> FALSE,rDurableBefore |-> (r1 :> FALSE),pendingDelete |-> {},present |-> [b1 |-> TRUE],folded |-> {},holes |-> 0]),
    ([cursor |-> (r1 :> 0 @@ "ns_s" :> 1),sawConfirmNo |-> FALSE,rAnswer |-> (r1 :> "none"),sCacheRef |-> "m2",sLeader |-> FALSE,sPoison |-> FALSE,sDurableRef |-> "m2",sTarget |-> "m2",condemned |-> {"b1"},rState |-> (r1 :> "init"),nextId |-> 2,journal |-> {[id |-> 1, ns |-> "ns_s", blob |-> "b1", src |-> "s_m1", op |-> "del"]},sPending |-> FALSE,round |-> 1,gcPhase |-> "idle",sFence |-> TRUE,sawConfirmUnk |-> FALSE,rDurableBefore |-> (r1 :> FALSE),pendingDelete |-> {},present |-> [b1 |-> TRUE],folded |-> {},holes |-> 0]),
    ([cursor |-> (r1 :> 0 @@ "ns_s" :> 1),sawConfirmNo |-> FALSE,rAnswer |-> (r1 :> "none"),sCacheRef |-> "m2",sLeader |-> FALSE,sPoison |-> FALSE,sDurableRef |-> "m2",sTarget |-> "m2",condemned |-> {"b1"},rState |-> (r1 :> "init"),nextId |-> 2,journal |-> {[id |-> 1, ns |-> "ns_s", blob |-> "b1", src |-> "s_m1", op |-> "del"]},sPending |-> FALSE,round |-> 1,gcPhase |-> "folded",sFence |-> TRUE,sawConfirmUnk |-> FALSE,rDurableBefore |-> (r1 :> FALSE),pendingDelete |-> {},present |-> [b1 |-> TRUE],folded |-> {},holes |-> 0]),
    ([cursor |-> (r1 :> 0 @@ "ns_s" :> 1),sawConfirmNo |-> FALSE,rAnswer |-> (r1 :> "none"),sCacheRef |-> "m2",sLeader |-> FALSE,sPoison |-> FALSE,sDurableRef |-> "m2",sTarget |-> "m2",condemned |-> {"b1"},rState |-> (r1 :> "init"),nextId |-> 2,journal |-> {[id |-> 1, ns |-> "ns_s", blob |-> "b1", src |-> "s_m1", op |-> "del"]},sPending |-> FALSE,round |-> 2,gcPhase |-> "idle",sFence |-> TRUE,sawConfirmUnk |-> FALSE,rDurableBefore |-> (r1 :> FALSE),pendingDelete |-> {"b1"},present |-> [b1 |-> TRUE],folded |-> {},holes |-> 0]),
    ([cursor |-> (r1 :> 0 @@ "ns_s" :> 1),sawConfirmNo |-> FALSE,rAnswer |-> (r1 :> "none"),sCacheRef |-> "m2",sLeader |-> FALSE,sPoison |-> FALSE,sDurableRef |-> "m2",sTarget |-> "m2",condemned |-> {"b1"},rState |-> (r1 :> "init"),nextId |-> 2,journal |-> {[id |-> 1, ns |-> "ns_s", blob |-> "b1", src |-> "s_m1", op |-> "del"]},sPending |-> FALSE,round |-> 2,gcPhase |-> "folded",sFence |-> TRUE,sawConfirmUnk |-> FALSE,rDurableBefore |-> (r1 :> FALSE),pendingDelete |-> {"b1"},present |-> [b1 |-> TRUE],folded |-> {},holes |-> 0]),
    ([cursor |-> (r1 :> 0 @@ "ns_s" :> 1),sawConfirmNo |-> FALSE,rAnswer |-> (r1 :> "none"),sCacheRef |-> "m2",sLeader |-> FALSE,sPoison |-> FALSE,sDurableRef |-> "m2",sTarget |-> "m2",condemned |-> {},rState |-> (r1 :> "init"),nextId |-> 2,journal |-> {[id |-> 1, ns |-> "ns_s", blob |-> "b1", src |-> "s_m1", op |-> "del"]},sPending |-> FALSE,round |-> 3,gcPhase |-> "idle",sFence |-> TRUE,sawConfirmUnk |-> FALSE,rDurableBefore |-> (r1 :> FALSE),pendingDelete |-> {},present |-> [b1 |-> FALSE],folded |-> {},holes |-> 0]),
    ([cursor |-> (r1 :> 0 @@ "ns_s" :> 1),sawConfirmNo |-> FALSE,rAnswer |-> (r1 :> "none"),sCacheRef |-> "m2",sLeader |-> FALSE,sPoison |-> FALSE,sDurableRef |-> "m2",sTarget |-> "m2",condemned |-> {},rState |-> (r1 :> "published"),nextId |-> 3,journal |-> {[id |-> 1, ns |-> "ns_s", blob |-> "b1", src |-> "s_m1", op |-> "del"], [id |-> 2, ns |-> r1, blob |-> "b1", src |-> r1, op |-> "add"]},sPending |-> FALSE,round |-> 3,gcPhase |-> "idle",sFence |-> TRUE,sawConfirmUnk |-> FALSE,rDurableBefore |-> (r1 :> FALSE),pendingDelete |-> {},present |-> [b1 |-> FALSE],folded |-> {},holes |-> 0]),
    ([cursor |-> (r1 :> 0 @@ "ns_s" :> 1),sawConfirmNo |-> FALSE,rAnswer |-> (r1 :> "yes"),sCacheRef |-> "m2",sLeader |-> FALSE,sPoison |-> FALSE,sDurableRef |-> "m2",sTarget |-> "m2",condemned |-> {},rState |-> (r1 :> "confirmed"),nextId |-> 3,journal |-> {[id |-> 1, ns |-> "ns_s", blob |-> "b1", src |-> "s_m1", op |-> "del"], [id |-> 2, ns |-> r1, blob |-> "b1", src |-> r1, op |-> "add"]},sPending |-> FALSE,round |-> 3,gcPhase |-> "idle",sFence |-> TRUE,sawConfirmUnk |-> FALSE,rDurableBefore |-> (r1 :> TRUE),pendingDelete |-> {},present |-> [b1 |-> FALSE],folded |-> {},holes |-> 0]),
...
---- CONFIG CaRelinkConfirmCore_TTrace_1785648727 ----
CONSTANTS
    Receivers = { r1 }
    MaxId = 5
    MaxRound = 5
    MaxHoles = 0
    SabotageNoGate1 = TRUE
