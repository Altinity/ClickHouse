---- MODULE CaGcAckFloorCore_TTrace_1785648383 ----
...
\* to `JsonSerialize`. For example, a sub-sequence of _TETrace.
    \* ASSUME
    \*     LET J == INSTANCE Json
    \*         IN J!JsonSerialize("CaGcAckFloorCore_TTrace_1785648383.json", _TETrace)
...
\*
\*trace == IODeserialize("CaGcAckFloorCore_TTrace_1785648383.bin", TRUE)
\*
\*=============================================================================
\*
...
---- CONFIG CaGcAckFloorCore_TTrace_1785648383 ----
CONSTANTS
    Writers = { w1 , w2 }
    Blobs = { b1 }
    MaxRound = 4
...
ALIAS
    _expression
=============================================================================
\* Generated on Sun Aug 02 07:26:24 CEST 2026