---- MODULE CaRetiredInRun_TTrace_1785647531 ----
...
\* to `JsonSerialize`. For example, a sub-sequence of _TETrace.
    \* ASSUME
    \*     LET J == INSTANCE Json
    \*         IN J!JsonSerialize("CaRetiredInRun_TTrace_1785647531.json", _TETrace)
...
\*
\*trace == IODeserialize("CaRetiredInRun_TTrace_1785647531.bin", TRUE)
\*
\*=============================================================================
\*
...
---- CONFIG CaRetiredInRun_TTrace_1785647531 ----
CONSTANTS
    Blobs = { b1 , b2 }
    MaxRound = 4
    MaxToken = 3
...
ALIAS
    _expression
=============================================================================
\* Generated on Sun Aug 02 07:12:12 CEST 2026