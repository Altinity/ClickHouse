---- MODULE CaGcRootLocalPartManifestCore_TTrace_1785658668 ----
...
\* to `JsonSerialize`. For example, a sub-sequence of _TETrace.
    \* ASSUME
    \*     LET J == INSTANCE Json
    \*         IN J!JsonSerialize("CaGcRootLocalPartManifestCore_TTrace_1785658668.json", _TETrace)
...
\*
\*trace == IODeserialize("CaGcRootLocalPartManifestCore_TTrace_1785658668.bin", TRUE)
\*
\*=============================================================================
\*
...
trace == 
    ...
    ([cursor |-> (n1 :> 0),deadTok |-> (b1 :> {}),blobEdges |-> {},shardIndeg |-> (s1 :> (b1 :> 0)),listedTok |-> (n1 :> 0),attemptSeq |-> 1,fencePos |-> (n1 :> 0),trimBase |-> (n1 :> 0),wView |-> (w1 :> 0),foldTok |-> (n1 :> 0),nextTok |-> (b1 :> 1),storedTok |-> (b1 :> 0),roundOf |-> (L1 :> 0),tokOf |-> (b1 :> 0),sweepEligible |-> (bp1 :> FALSE),mNs |-> (<<n1, m1>> :> n1 @@ <<n1, m2>> :> n1),journal |-> (n1 :> <<>>),mRef |-> (<<n1, m1>> :> <<n1, m1>> @@ <<n1, m2>> :> <<n1, m2>>),gcPhase |-> (L1 :> "idle"),coordFence |-> (n1 :> 0),reducerOwner |-> (s1 :> L1),mEntries |-> (<<n1, m1>> :> (p1 :> b1) @@ <<n1, m2>> :> (p1 :> "noblob")),attViewable |-> (0 :> {} @@ 1 :> {}),retired |-> {},gcRound |-> 0,blobIndeg |-> (b1 :> 0),mPrefix |-> (<<n1, m1>> :> bp1 @@ <<n1, m2>> :> bp1),extraShared |-> {},owner |-> (<<n1, m1>> :> "none" @@ <<n1, m2>> :> "none"),foldSeal |-> (0 :> [foldedCursor |-> (n1 :> 0), classified |-> {}] @@ 1 :> [foldedCursor |-> (n1 :> 0), classified |-> {}]),prevFencePos |-> (n1 :> 0),sealAt |-> (0 :> {1} @@ 1 :> {}),everEdged |-> {<<n1, m1>>},fenceVersion |-> (0 :> (n1 :> 0) @@ 1 :> (n1 :> 0)),mActiveEdges |-> (<<n1, m1>> :> (p1 :> "noblob") @@ <<n1, m2>> :> (p1 :> "noblob")),completionSeal |-> (0 :> [fenced |-> {}, rechecked |-> {}, deleted |-> {}, adoptable |-> FALSE] @@ 1 :> [fenced |-> {}, rechecked |-> {}, deleted |-> {}, adoptable |-> FALSE]),mfCleanup |-> {},inflight |-> {},mBody |-> (<<n1, m1>> :> TRUE @@ <<n1, m2>> :> FALSE),retiredAt |-> (0 :> {1} @@ 1 :> {}),foldedTok |-> (n1 :> 0),present |-> (b1 :> FALSE),mfDeleted |-> {},adopted |-> (0 :> 0 @@ 1 :> 0)]),
    ([cursor |-> (n1 :> 0),deadTok |-> (b1 :> {}),blobEdges |-> {},shardIndeg |-> (s1 :> (b1 :> 0)),listedTok |-> (n1 :> 0),attemptSeq |-> 2,fencePos |-> (n1 :> 0),trimBase |-> (n1 :> 0),wView |-> (w1 :> 0),foldTok |-> (n1 :> 0),nextTok |-> (b1 :> 1),storedTok |-> (b1 :> 0),roundOf |-> (L1 :> 0),tokOf |-> (b1 :> 0),sweepEligible |-> (bp1 :> FALSE),mNs |-> (<<n1, m1>> :> n1 @@ <<n1, m2>> :> n1),journal |-> (n1 :> <<>>),mRef |-> (<<n1, m1>> :> <<n1, m1>> @@ <<n1, m2>> :> <<n1, m2>>),gcPhase |-> (L1 :> "idle"),coordFence |-> (n1 :> 0),reducerOwner |-> (s1 :> L1),mEntries |-> (<<n1, m1>> :> (p1 :> b1) @@ <<n1, m2>> :> (p1 :> "noblob")),attViewable |-> (0 :> {} @@ 1 :> {}),retired |-> {},gcRound |-> 0,blobIndeg |-> (b1 :> 0),mPrefix |-> (<<n1, m1>> :> bp1 @@ <<n1, m2>> :> bp1),extraShared |-> {},owner |-> (<<n1, m1>> :> "none" @@ <<n1, m2>> :> "none"),foldSeal |-> (0 :> [foldedCursor |-> (n1 :> 0), classified |-> {}] @@ 1 :> [foldedCursor |-> (n1 :> 0), classified |-> {}]),prevFencePos |-> (n1 :> 0),sealAt |-> (0 :> {1} @@ 1 :> {2}),everEdged |-> {<<n1, m1>>},fenceVersion |-> (0 :> (n1 :> 0) @@ 1 :> (n1 :> 0)),mActiveEdges |-> (<<n1, m1>> :> (p1 :> "noblob") @@ <<n1, m2>> :> (p1 :> "noblob")),completionSeal |-> (0 :> [fenced |-> {}, rechecked |-> {}, deleted |-> {}, adoptable |-> FALSE] @@ 1 :> [fenced |-> {}, rechecked |-> {}, deleted |-> {}, adoptable |-> FALSE]),mfCleanup |-> {},inflight |-> {},mBody |-> (<<n1, m1>> :> TRUE @@ <<n1, m2>> :> FALSE),retiredAt |-> (0 :> {1} @@ 1 :> {2}),foldedTok |-> (n1 :> 0),present |-> (b1 :> FALSE),mfDeleted |-> {},adopted |-> (0 :> 0 @@ 1 :> 0)]),
    ([cursor |-> (n1 :> 0),deadTok |-> (b1 :> {}),blobEdges |-> {},shardIndeg |-> (s1 :> (b1 :> 0)),listedTok |-> (n1 :> 0),attemptSeq |-> 2,fencePos |-> (n1 :> 0),trimBase |-> (n1 :> 0),wView |-> (w1 :> 0),foldTok |-> (n1 :> 0),nextTok |-> (b1 :> 1),storedTok |-> (b1 :> 0),roundOf |-> (L1 :> 0),tokOf |-> (b1 :> 0),sweepEligible |-> (bp1 :> FALSE),mNs |-> (<<n1, m1>> :> n1 @@ <<n1, m2>> :> n1),journal |-> (n1 :> <<>>),mRef |-> (<<n1, m1>> :> <<n1, m1>> @@ <<n1, m2>> :> <<n1, m2>>),gcPhase |-> (L1 :> "idle"),coordFence |-> (n1 :> 0),reducerOwner |-> (s1 :> L1),mEntries |-> (<<n1, m1>> :> (p1 :> b1) @@ <<n1, m2>> :> (p1 :> "noblob")),attViewable |-> (0 :> {1} @@ 1 :> {}),retired |-> {},gcRound |-> 0,blobIndeg |-> (b1 :> 0),mPrefix |-> (<<n1, m1>> :> bp1 @@ <<n1, m2>> :> bp1),extraShared |-> {},owner |-> (<<n1, m1>> :> "none" @@ <<n1, m2>> :> "none"),foldSeal |-> (0 :> [foldedCursor |-> (n1 :> 0), classified |-> {}] @@ 1 :> [foldedCursor |-> (n1 :> 0), classified |-> {}]),prevFencePos |-> (n1 :> 0),sealAt |-> (0 :> {1} @@ 1 :> {2}),everEdged |-> {<<n1, m1>>},fenceVersion |-> (0 :> (n1 :> 0) @@ 1 :> (n1 :> 0)),mActiveEdges |-> (<<n1, m1>> :> (p1 :> "noblob") @@ <<n1, m2>> :> (p1 :> "noblob")),completionSeal |-> (0 :> [fenced |-> {}, rechecked |-> {}, deleted |-> {}, adoptable |-> FALSE] @@ 1 :> [fenced |-> {}, rechecked |-> {}, deleted |-> {}, adoptable |-> FALSE]),mfCleanup |-> {},inflight |-> {},mBody |-> (<<n1, m1>> :> TRUE @@ <<n1, m2>> :> FALSE),retiredAt |-> (0 :> {1} @@ 1 :> {2}),foldedTok |-> (n1 :> 0),present |-> (b1 :> FALSE),mfDeleted |-> {},adopted |-> (0 :> 1 @@ 1 :> 0)]),
    ([cursor |-> (n1 :> 0),deadTok |-> (b1 :> {}),blobEdges |-> {},shardIndeg |-> (s1 :> (b1 :> 0)),listedTok |-> (n1 :> 0),attemptSeq |-> 2,fencePos |-> (n1 :> 0),trimBase |-> (n1 :> 0),wView |-> (w1 :> 0),foldTok |-> (n1 :> 0),nextTok |-> (b1 :> 1),storedTok |-> (b1 :> 0),roundOf |-> (L1 :> 0),tokOf |-> (b1 :> 0),sweepEligible |-> (bp1 :> FALSE),mNs |-> (<<n1, m1>> :> n1 @@ <<n1, m2>> :> n1),journal |-> (n1 :> <<>>),mRef |-> (<<n1, m1>> :> <<n1, m1>> @@ <<n1, m2>> :> <<n1, m2>>),gcPhase |-> (L1 :> "idle"),coordFence |-> (n1 :> 0),reducerOwner |-> (s1 :> L1),mEntries |-> (<<n1, m1>> :> (p1 :> b1) @@ <<n1, m2>> :> (p1 :> "noblob")),attViewable |-> (0 :> {1, 2} @@ 1 :> {}),retired |-> {},gcRound |-> 0,blobIndeg |-> (b1 :> 0),mPrefix |-> (<<n1, m1>> :> bp1 @@ <<n1, m2>> :> bp1),extraShared |-> {},owner |-> (<<n1, m1>> :> "none" @@ <<n1, m2>> :> "none"),foldSeal |-> (0 :> [foldedCursor |-> (n1 :> 0), classified |-> {}] @@ 1 :> [foldedCursor |-> (n1 :> 0), classified |-> {}]),prevFencePos |-> (n1 :> 0),sealAt |-> (0 :> {1, 2} @@ 1 :> {2}),everEdged |-> {<<n1, m1>>},fenceVersion |-> (0 :> (n1 :> 0) @@ 1 :> (n1 :> 0)),mActiveEdges |-> (<<n1, m1>> :> (p1 :> "noblob") @@ <<n1, m2>> :> (p1 :> "noblob")),completionSeal |-> (0 :> [fenced |-> {}, rechecked |-> {}, deleted |-> {}, adoptable |-> FALSE] @@ 1 :> [fenced |-> {}, rechecked |-> {}, deleted |-> {}, adoptable |-> FALSE]),mfCleanup |-> {},inflight |-> {},mBody |-> (<<n1, m1>> :> TRUE @@ <<n1, m2>> :> FALSE),retiredAt |-> (0 :> {1, 2} @@ 1 :> {2}),foldedTok |-> (n1 :> 0),present |-> (b1 :> FALSE),mfDeleted |-> {},adopted |-> (0 :> 1 @@ 1 :> 0)])
    >>
----
...
---- CONFIG CaGcRootLocalPartManifestCore_TTrace_1785658668 ----
CONSTANTS
    Namespaces = { n1 }
    Writers = { w1 }
    Leaders = { L1 }
    ...
    SabotageDeposedLeaderWritesFinalGen = TRUE
    MaxAttempt = 2
    bd1 = bd1
    p1 = p1
    s1 = s1
...
ALIAS
    _expression
=============================================================================
\* Generated on Sun Aug 02 10:17:49 CEST 2026