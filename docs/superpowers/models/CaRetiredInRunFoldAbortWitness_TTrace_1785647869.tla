---- MODULE CaRetiredInRunFoldAbortWitness_TTrace_1785647869 ----
...
_inv ==
    ~(
        ...
        badDeleteEver = (TRUE)
        /\
        leaders = ([La |-> [cut |-> 2, phase |-> "executed", snap |-> [round |-> 2, gen |-> 2, cut |-> 2, edges |-> (b1 :> 0 @@ b2 :> 0), cond |-> (b1 :> [st |-> "pend", tok |-> 1, round |-> 1] @@ b2 :> [st |-> "none", tok |-> 0, round |-> 0])], attempt |-> 3, art |-> [round |-> 3, gen |-> 3, cut |-> 2, edges |-> (b1 :> 0 @@ b2 :> 0), cond |-> (b1 :> [st |-> "none", tok |-> 0, round |-> 0] @@ b2 :> [st |-> "none", tok |-> 0, round |-> 0])]], Lb |-> [cut |-> 0, phase |-> "idle", snap |-> [round |-> 0, gen |-> 0, cut |-> 0, edges |-> (b1 :> 0 @@ b2 :> 0), cond |-> (b1 :> [st |-> "none", tok |-> 0, round |-> 0] @@ b2 :> [st |-> "none", tok |-> 0, round |-> 0])], attempt |-> 0, art |-> [round |-> 0, gen |-> 0, cut |-> 0, edges |-> (b1 :> 0 @@ b2 :> 0), cond |-> (b1 :> [st |-> "none", tok |-> 0, round |-> 0] @@ b2 :> [st |-> "none", tok |-> 0, round |-> 0])]]])
        /\
        nextTok = ((b1 :> 3 @@ b2 :> 1))
        /\
        ...
        nextAttempt = (4)
        /\
        adopted = ([round |-> 2, gen |-> 2, cut |-> 2, edges |-> (b1 :> 0 @@ b2 :> 0), cond |-> (b1 :> [st |-> "pend", tok |-> 1, round |-> 1] @@ b2 :> [st |-> "none", tok |-> 0, round |-> 0])])
        /\
        lenAtAdopt = (2)
        /\
        artifacts = (<<[round |-> 1, gen |-> 1, cut |-> 2, edges |-> (b1 :> 0 @@ b2 :> 0), cond |-> (b1 :> [st |-> "cond", tok |-> 1, round |-> 1] @@ b2 :> [st |-> "none", tok |-> 0, round |-> 0])], [round |-> 2, gen |-> 2, cut |-> 2, edges |-> (b1 :> 0 @@ b2 :> 0), cond |-> (b1 :> [st |-> "pend", tok |-> 1, round |-> 1] @@ b2 :> [st |-> "none", tok |-> 0, round |-> 0])]>>)
    )
----
...
\* to `JsonSerialize`. For example, a sub-sequence of _TETrace.
    \* ASSUME
    \*     LET J == INSTANCE Json
    \*         IN J!JsonSerialize("CaRetiredInRunFoldAbortWitness_TTrace_1785647869.json", _TETrace)
...
\*
\*trace == IODeserialize("CaRetiredInRunFoldAbortWitness_TTrace_1785647869.bin", TRUE)
\*
\*=============================================================================
\*
...
trace == 
    ...
    ([unresolved |-> (b1 :> FALSE @@ b2 :> FALSE),journal |-> <<<<b1, "add">>, <<b1, "rm">>>>,meta |-> (b1 :> "cond" @@ b2 :> "clean"),phys |-> (b1 :> 1 @@ b2 :> 0),badDeleteEver |-> FALSE,leaders |-> [La |-> [cut |-> 2, phase |-> "idle", snap |-> [round |-> 1, gen |-> 1, cut |-> 2, edges |-> (b1 :> 0 @@ b2 :> 0), cond |-> (b1 :> [st |-> "cond", tok |-> 1, round |-> 1] @@ b2 :> [st |-> "none", tok |-> 0, round |-> 0])], attempt |-> 2, art |-> [round |-> 2, gen |-> 2, cut |-> 2, edges |-> (b1 :> 0 @@ b2 :> 0), cond |-> (b1 :> [st |-> "pend", tok |-> 1, round |-> 1] @@ b2 :> [st |-> "none", tok |-> 0, round |-> 0])]], Lb |-> [cut |-> 0, phase |-> "idle", snap |-> [round |-> 0, gen |-> 0, cut |-> 0, edges |-> (b1 :> 0 @@ b2 :> 0), cond |-> (b1 :> [st |-> "none", tok |-> 0, round |-> 0] @@ b2 :> [st |-> "none", tok |-> 0, round |-> 0])], attempt |-> 0, art |-> [round |-> 0, gen |-> 0, cut |-> 0, edges |-> (b1 :> 0 @@ b2 :> 0), cond |-> (b1 :> [st |-> "none", tok |-> 0, round |-> 0] @@ b2 :> [st |-> "none", tok |-> 0, round |-> 0])]]],nextTok |-> (b1 :> 2 @@ b2 :> 1),liveRef |-> (b1 :> FALSE @@ b2 :> FALSE),nextAttempt |-> 3,adopted |-> [round |-> 2, gen |-> 2, cut |-> 2, edges |-> (b1 :> 0 @@ b2 :> 0), cond |-> (b1 :> [st |-> "pend", tok |-> 1, round |-> 1] @@ b2 :> [st |-> "none", tok |-> 0, round |-> 0])],lenAtAdopt |-> 2,artifacts |-> <<[round |-> 1, gen |-> 1, cut |-> 2, edges |-> (b1 :> 0 @@ b2 :> 0), cond |-> (b1 :> [st |-> "cond", tok |-> 1, round |-> 1] @@ b2 :> [st |-> "none", tok |-> 0, round |-> 0])], [round |-> 2, gen |-> 2, cut |-> 2, edges |-> (b1 :> 0 @@ b2 :> 0), cond |-> (b1 :> [st |-> "pend", tok |-> 1, round |-> 1] @@ b2 :> [st |-> "none", tok |-> 0, round |-> 0])]>>]),
    ...
    ([unresolved |-> (b1 :> FALSE @@ b2 :> FALSE),journal |-> <<<<b1, "add">>, <<b1, "rm">>, <<b1, "add">>>>,meta |-> (b1 :> "clean" @@ b2 :> "clean"),phys |-> (b1 :> 2 @@ b2 :> 0),badDeleteEver |-> FALSE,leaders |-> [La |-> [cut |-> 2, phase |-> "idle", snap |-> [round |-> 1, gen |-> 1, cut |-> 2, edges |-> (b1 :> 0 @@ b2 :> 0), cond |-> (b1 :> [st |-> "cond", tok |-> 1, round |-> 1] @@ b2 :> [st |-> "none", tok |-> 0, round |-> 0])], attempt |-> 2, art |-> [round |-> 2, gen |-> 2, cut |-> 2, edges |-> (b1 :> 0 @@ b2 :> 0), cond |-> (b1 :> [st |-> "pend", tok |-> 1, round |-> 1] @@ b2 :> [st |-> "none", tok |-> 0, round |-> 0])]], Lb |-> [cut |-> 0, phase |-> "idle", snap |-> [round |-> 0, gen |-> 0, cut |-> 0, edges |-> (b1 :> 0 @@ b2 :> 0), cond |-> (b1 :> [st |-> "none", tok |-> 0, round |-> 0] @@ b2 :> [st |-> "none", tok |-> 0, round |-> 0])], attempt |-> 0, art |-> [round |-> 0, gen |-> 0, cut |-> 0, edges |-> (b1 :> 0 @@ b2 :> 0), cond |-> (b1 :> [st |-> "none", tok |-> 0, round |-> 0] @@ b2 :> [st |-> "none", tok |-> 0, round |-> 0])]]],nextTok |-> (b1 :> 3 @@ b2 :> 1),liveRef |-> (b1 :> TRUE @@ b2 :> FALSE),nextAttempt |-> 3,adopted |-> [round |-> 2, gen |-> 2, cut |-> 2, edges |-> (b1 :> 0 @@ b2 :> 0), cond |-> (b1 :> [st |-> "pend", tok |-> 1, round |-> 1] @@ b2 :> [st |-> "none", tok |-> 0, round |-> 0])],lenAtAdopt |-> 2,artifacts |-> <<[round |-> 1, gen |-> 1, cut |-> 2, edges |-> (b1 :> 0 @@ b2 :> 0), cond |-> (b1 :> [st |-> "cond", tok |-> 1, round |-> 1] @@ b2 :> [st |-> "none", tok |-> 0, round |-> 0])], [round |-> 2, gen |-> 2, cut |-> 2, edges |-> (b1 :> 0 @@ b2 :> 0), cond |-> (b1 :> [st |-> "pend", tok |-> 1, round |-> 1] @@ b2 :> [st |-> "none", tok |-> 0, round |-> 0])]>>]),
    ([unresolved |-> (b1 :> FALSE @@ b2 :> FALSE),journal |-> <<<<b1, "add">>, <<b1, "rm">>, <<b1, "add">>>>,meta |-> (b1 :> "clean" @@ b2 :> "clean"),phys |-> (b1 :> 2 @@ b2 :> 0),badDeleteEver |-> FALSE,leaders |-> [La |-> [cut |-> 2, phase |-> "captured", snap |-> [round |-> 2, gen |-> 2, cut |-> 2, edges |-> (b1 :> 0 @@ b2 :> 0), cond |-> (b1 :> [st |-> "pend", tok |-> 1, round |-> 1] @@ b2 :> [st |-> "none", tok |-> 0, round |-> 0])], attempt |-> 3, art |-> [round |-> 0, gen |-> 0, cut |-> 0, edges |-> (b1 :> 0 @@ b2 :> 0), cond |-> (b1 :> [st |-> "none", tok |-> 0, round |-> 0] @@ b2 :> [st |-> "none", tok |-> 0, round |-> 0])]], Lb |-> [cut |-> 0, phase |-> "idle", snap |-> [round |-> 0, gen |-> 0, cut |-> 0, edges |-> (b1 :> 0 @@ b2 :> 0), cond |-> (b1 :> [st |-> "none", tok |-> 0, round |-> 0] @@ b2 :> [st |-> "none", tok |-> 0, round |-> 0])], attempt |-> 0, art |-> [round |-> 0, gen |-> 0, cut |-> 0, edges |-> (b1 :> 0 @@ b2 :> 0), cond |-> (b1 :> [st |-> "none", tok |-> 0, round |-> 0] @@ b2 :> [st |-> "none", tok |-> 0, round |-> 0])]]],nextTok |-> (b1 :> 3 @@ b2 :> 1),liveRef |-> (b1 :> TRUE @@ b2 :> FALSE),nextAttempt |-> 4,adopted |-> [round |-> 2, gen |-> 2, cut |-> 2, edges |-> (b1 :> 0 @@ b2 :> 0), cond |-> (b1 :> [st |-> "pend", tok |-> 1, round |-> 1] @@ b2 :> [st |-> "none", tok |-> 0, round |-> 0])],lenAtAdopt |-> 2,artifacts |-> <<[round |-> 1, gen |-> 1, cut |-> 2, edges |-> (b1 :> 0 @@ b2 :> 0), cond |-> (b1 :> [st |-> "cond", tok |-> 1, round |-> 1] @@ b2 :> [st |-> "none", tok |-> 0, round |-> 0])], [round |-> 2, gen |-> 2, cut |-> 2, edges |-> (b1 :> 0 @@ b2 :> 0), cond |-> (b1 :> [st |-> "pend", tok |-> 1, round |-> 1] @@ b2 :> [st |-> "none", tok |-> 0, round |-> 0])]>>]),
    ([unresolved |-> (b1 :> FALSE @@ b2 :> FALSE),journal |-> <<<<b1, "add">>, <<b1, "rm">>, <<b1, "add">>>>,meta |-> (b1 :> "clean" @@ b2 :> "clean"),phys |-> (b1 :> 0 @@ b2 :> 0),badDeleteEver |-> TRUE,leaders |-> [La |-> [cut |-> 2, phase |-> "executed", snap |-> [round |-> 2, gen |-> 2, cut |-> 2, edges |-> (b1 :> 0 @@ b2 :> 0), cond |-> (b1 :> [st |-> "pend", tok |-> 1, round |-> 1] @@ b2 :> [st |-> "none", tok |-> 0, round |-> 0])], attempt |-> 3, art |-> [round |-> 3, gen |-> 3, cut |-> 2, edges |-> (b1 :> 0 @@ b2 :> 0), cond |-> (b1 :> [st |-> "none", tok |-> 0, round |-> 0] @@ b2 :> [st |-> "none", tok |-> 0, round |-> 0])]], Lb |-> [cut |-> 0, phase |-> "idle", snap |-> [round |-> 0, gen |-> 0, cut |-> 0, edges |-> (b1 :> 0 @@ b2 :> 0), cond |-> (b1 :> [st |-> "none", tok |-> 0, round |-> 0] @@ b2 :> [st |-> "none", tok |-> 0, round |-> 0])], attempt |-> 0, art |-> [round |-> 0, gen |-> 0, cut |-> 0, edges |-> (b1 :> 0 @@ b2 :> 0), cond |-> (b1 :> [st |-> "none", tok |-> 0, round |-> 0] @@ b2 :> [st |-> "none", tok |-> 0, round |-> 0])]]],nextTok |-> (b1 :> 3 @@ b2 :> 1),liveRef |-> (b1 :> TRUE @@ b2 :> FALSE),nextAttempt |-> 4,adopted |-> [round |-> 2, gen |-> 2, cut |-> 2, edges |-> (b1 :> 0 @@ b2 :> 0), cond |-> (b1 :> [st |-> "pend", tok |-> 1, round |-> 1] @@ b2 :> [st |-> "none", tok |-> 0, round |-> 0])],lenAtAdopt |-> 2,artifacts |-> <<[round |-> 1, gen |-> 1, cut |-> 2, edges |-> (b1 :> 0 @@ b2 :> 0), cond |-> (b1 :> [st |-> "cond", tok |-> 1, round |-> 1] @@ b2 :> [st |-> "none", tok |-> 0, round |-> 0])], [round |-> 2, gen |-> 2, cut |-> 2, edges |-> (b1 :> 0 @@ b2 :> 0), cond |-> (b1 :> [st |-> "pend", tok |-> 1, round |-> 1] @@ b2 :> [st |-> "none", tok |-> 0, round |-> 0])]>>])
    >>
----
...
---- CONFIG CaRetiredInRunFoldAbortWitness_TTrace_1785647869 ----
CONSTANTS
    Blobs = { b1 , b2 }
    MaxRound = 4
    MaxToken = 3
    MaxJournal = 5
    Sabotage = "inmem_token"
    b2 = b2
    b1 = b1
...
ALIAS
    _expression
=============================================================================
\* Generated on Sun Aug 02 07:17:51 CEST 2026