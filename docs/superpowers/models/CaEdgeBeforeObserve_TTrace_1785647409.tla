---- MODULE CaEdgeBeforeObserve_TTrace_1785647409 ----
...
\* to `JsonSerialize`. For example, a sub-sequence of _TETrace.
    \* ASSUME
    \*     LET J == INSTANCE Json
    \*         IN J!JsonSerialize("CaEdgeBeforeObserve_TTrace_1785647409.json", _TETrace)
...
\*
\*trace == IODeserialize("CaEdgeBeforeObserve_TTrace_1785647409.bin", TRUE)
\*
\*=============================================================================
\*
...
trace == 
    ...
    ([precommitted |-> FALSE,entry |-> [ht |-> [st |-> "none", r |-> 0], he |-> [st |-> "none", r |-> 0]],view |-> 1,committed |-> FALSE,round |-> 1,aborted |-> FALSE,doomed |-> {},present |-> [ht |-> TRUE, he |-> TRUE],adopted |-> TRUE]),
    ([precommitted |-> FALSE,entry |-> [ht |-> [st |-> "cond", r |-> 1], he |-> [st |-> "cond", r |-> 1]],view |-> 1,committed |-> FALSE,round |-> 2,aborted |-> FALSE,doomed |-> {},present |-> [ht |-> TRUE, he |-> TRUE],adopted |-> TRUE]),
    ([precommitted |-> FALSE,entry |-> [ht |-> [st |-> "cond", r |-> 1], he |-> [st |-> "cond", r |-> 1]],view |-> 2,committed |-> FALSE,round |-> 2,aborted |-> FALSE,doomed |-> {},present |-> [ht |-> TRUE, he |-> TRUE],adopted |-> TRUE]),
    ([precommitted |-> FALSE,entry |-> [ht |-> [st |-> "pend", r |-> 1], he |-> [st |-> "pend", r |-> 1]],view |-> 2,committed |-> FALSE,round |-> 3,aborted |-> FALSE,doomed |-> {},present |-> [ht |-> TRUE, he |-> TRUE],adopted |-> TRUE]),
    ([precommitted |-> FALSE,entry |-> [ht |-> [st |-> "pend", r |-> 1], he |-> [st |-> "pend", r |-> 1]],view |-> 2,committed |-> FALSE,round |-> 4,aborted |-> FALSE,doomed |-> {"ht", "he"},present |-> [ht |-> TRUE, he |-> TRUE],adopted |-> TRUE]),
    ([precommitted |-> TRUE,entry |-> [ht |-> [st |-> "pend", r |-> 1], he |-> [st |-> "pend", r |-> 1]],view |-> 2,committed |-> FALSE,round |-> 4,aborted |-> FALSE,doomed |-> {"ht", "he"},present |-> [ht |-> TRUE, he |-> TRUE],adopted |-> TRUE]),
    ([precommitted |-> TRUE,entry |-> [ht |-> [st |-> "none", r |-> 0], he |-> [st |-> "pend", r |-> 1]],view |-> 2,committed |-> FALSE,round |-> 4,aborted |-> FALSE,doomed |-> {"he"},present |-> [ht |-> FALSE, he |-> TRUE],adopted |-> TRUE]),
    ([precommitted |-> TRUE,entry |-> [ht |-> [st |-> "none", r |-> 0], he |-> [st |-> "none", r |-> 0]],view |-> 2,committed |-> TRUE,round |-> 4,aborted |-> FALSE,doomed |-> {},present |-> [ht |-> FALSE, he |-> TRUE],adopted |-> TRUE])
    >>
----
...
---- CONFIG CaEdgeBeforeObserve_TTrace_1785647409 ----
CONSTANTS
    MaxRound = 6
    OrderSabotage = TRUE
    AdoptCheck = TRUE
