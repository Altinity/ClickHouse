---- MODULE CaRelinkConfirmCore_TTrace_1785648741 ----
...
\* to `JsonSerialize`. For example, a sub-sequence of _TETrace.
    \* ASSUME
    \*     LET J == INSTANCE Json
    \*         IN J!JsonSerialize("CaRelinkConfirmCore_TTrace_1785648741.json", _TETrace)
...
\*
\*trace == IODeserialize("CaRelinkConfirmCore_TTrace_1785648741.bin", TRUE)
\*
\*=============================================================================
\*
...
trace == 
    ...
    ([cursor |-> (r1 :> 0 @@ "ns_s" :> 0),sawConfirmNo |-> FALSE,rAnswer |-> (r1 :> "none"),sCacheRef |-> "m1",sLeader |-> FALSE,sPoison |-> FALSE,sDurableRef |-> "none",sTarget |-> "m1",condemned |-> {},rState |-> (r1 :> "published"),nextId |-> 3,journal |-> {[id |-> 1, ns |-> "ns_s", blob |-> "b1", src |-> "s_m1", op |-> "del"], [id |-> 2, ns |-> r1, blob |-> "b1", src |-> r1, op |-> "add"]},sPending |-> FALSE,round |-> 0,gcPhase |-> "idle",sFence |-> FALSE,sawConfirmUnk |-> FALSE,rDurableBefore |-> (r1 :> FALSE),pendingDelete |-> {},present |-> [b1 |-> TRUE],folded |-> {[src |-> "s_m1", b |-> "b1"]},holes |-> 0]),
    ([cursor |-> (r1 :> 0 @@ "ns_s" :> 0),sawConfirmNo |-> FALSE,rAnswer |-> (r1 :> "unknown"),sCacheRef |-> "m1",sLeader |-> FALSE,sPoison |-> FALSE,sDurableRef |-> "none",sTarget |-> "m1",condemned |-> {},rState |-> (r1 :> "confirmed"),nextId |-> 3,journal |-> {[id |-> 1, ns |-> "ns_s", blob |-> "b1", src |-> "s_m1", op |-> "del"], [id |-> 2, ns |-> r1, blob |-> "b1", src |-> r1, op |-> "add"]},sPending |-> FALSE,round |-> 0,gcPhase |-> "idle",sFence |-> FALSE,sawConfirmUnk |-> TRUE,rDurableBefore |-> (r1 :> TRUE),pendingDelete |-> {},present |-> [b1 |-> TRUE],folded |-> {[src |-> "s_m1", b |-> "b1"]},holes |-> 0])
    >>
----
...
---- CONFIG CaRelinkConfirmCore_TTrace_1785648741 ----
CONSTANTS
    Receivers = { r1 }
    MaxId = 5
    MaxRound = 5
...
ALIAS
    _expression
=============================================================================
\* Generated on Sun Aug 02 07:32:22 CEST 2026