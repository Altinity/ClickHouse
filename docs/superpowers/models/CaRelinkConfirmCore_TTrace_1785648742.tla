---- MODULE CaRelinkConfirmCore_TTrace_1785648742 ----
...
\* to `JsonSerialize`. For example, a sub-sequence of _TETrace.
    \* ASSUME
    \*     LET J == INSTANCE Json
    \*         IN J!JsonSerialize("CaRelinkConfirmCore_TTrace_1785648742.json", _TETrace)
...
\*
\*trace == IODeserialize("CaRelinkConfirmCore_TTrace_1785648742.bin", TRUE)
\*
\*=============================================================================
\*
...
trace == 
    ...
    ([cursor |-> (r1 :> 0 @@ "ns_s" :> 1),sawConfirmNo |-> FALSE,rAnswer |-> (r1 :> "none"),sCacheRef |-> "m1",sLeader |-> FALSE,sPoison |-> FALSE,sDurableRef |-> "none",sTarget |-> "m1",condemned |-> {},rState |-> (r1 :> "init"),nextId |-> 2,journal |-> {[id |-> 1, ns |-> "ns_s", blob |-> "b1", src |-> "s_m1", op |-> "del"]},sPending |-> FALSE,round |-> 3,gcPhase |-> "idle",sFence |-> FALSE,sawConfirmUnk |-> FALSE,rDurableBefore |-> (r1 :> FALSE),pendingDelete |-> {},present |-> [b1 |-> FALSE],folded |-> {},holes |-> 0])
    >>
----
...
---- CONFIG CaRelinkConfirmCore_TTrace_1785648742 ----
CONSTANTS
    Receivers = { r1 }
    MaxId = 5
    MaxRound = 5
...
ALIAS
    _expression
=============================================================================
\* Generated on Sun Aug 02 07:32:23 CEST 2026