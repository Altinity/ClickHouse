---- MODULE CaEdgeBeforeObserve_TTrace_1785647411 ----
...
\* to `JsonSerialize`. For example, a sub-sequence of _TETrace.
    \* ASSUME
    \*     LET J == INSTANCE Json
    \*         IN J!JsonSerialize("CaEdgeBeforeObserve_TTrace_1785647411.json", _TETrace)
...
\*
\*trace == IODeserialize("CaEdgeBeforeObserve_TTrace_1785647411.bin", TRUE)
\*
\*=============================================================================
\*
...
trace == 
    ...
    ([precommitted |-> FALSE,entry |-> [ht |-> [st |-> "cond", r |-> 1], he |-> [st |-> "cond", r |-> 1]],view |-> 0,committed |-> FALSE,round |-> 2,aborted |-> FALSE,doomed |-> {},present |-> [ht |-> TRUE, he |-> TRUE],adopted |-> FALSE]),
    ...
    ([precommitted |-> FALSE,entry |-> [ht |-> [st |-> "pend", r |-> 1], he |-> [st |-> "pend", r |-> 1]],view |-> 3,committed |-> FALSE,round |-> 3,aborted |-> FALSE,doomed |-> {},present |-> [ht |-> TRUE, he |-> TRUE],adopted |-> FALSE]),
    ([precommitted |-> FALSE,entry |-> [ht |-> [st |-> "pend", r |-> 1], he |-> [st |-> "pend", r |-> 1]],view |-> 3,committed |-> FALSE,round |-> 4,aborted |-> FALSE,doomed |-> {"ht", "he"},present |-> [ht |-> TRUE, he |-> TRUE],adopted |-> FALSE]),
    ([precommitted |-> TRUE,entry |-> [ht |-> [st |-> "pend", r |-> 1], he |-> [st |-> "pend", r |-> 1]],view |-> 3,committed |-> FALSE,round |-> 4,aborted |-> FALSE,doomed |-> {"ht", "he"},present |-> [ht |-> TRUE, he |-> TRUE],adopted |-> FALSE]),
    ([precommitted |-> TRUE,entry |-> [ht |-> [st |-> "none", r |-> 0], he |-> [st |-> "pend", r |-> 1]],view |-> 3,committed |-> FALSE,round |-> 4,aborted |-> FALSE,doomed |-> {"he"},present |-> [ht |-> TRUE, he |-> TRUE],adopted |-> TRUE]),
    ([precommitted |-> TRUE,entry |-> [ht |-> [st |-> "none", r |-> 0], he |-> [st |-> "none", r |-> 0]],view |-> 3,committed |-> FALSE,round |-> 4,aborted |-> FALSE,doomed |-> {},present |-> [ht |-> TRUE, he |-> FALSE],adopted |-> TRUE]),
    ([precommitted |-> TRUE,entry |-> [ht |-> [st |-> "none", r |-> 0], he |-> [st |-> "none", r |-> 0]],view |-> 3,committed |-> TRUE,round |-> 4,aborted |-> FALSE,doomed |-> {},present |-> [ht |-> TRUE, he |-> FALSE],adopted |-> TRUE])
    >>
----
...
---- CONFIG CaEdgeBeforeObserve_TTrace_1785647411 ----
CONSTANTS
    MaxRound = 6
    OrderSabotage = FALSE
    AdoptCheck = TRUE
...
ALIAS
    _expression
=============================================================================
\* Generated on Sun Aug 02 07:10:11 CEST 2026