---- MODULE CaGcRootLocalPartManifestCore_TTrace_1785658994 ----
...
_inv ==
    ~(
        ...
        /\
        mActiveEdges = ((<<n1, m1>> :> (p1 :> b1) @@ <<n1, m2>> :> (p1 :> "noblob")))
        /\
        completionSeal = ((0 :> [fenced |-> {}, rechecked |-> {}, deleted |-> {}, adoptable |-> FALSE] @@ 1 :> [fenced |-> {}, rechecked |-> {}, deleted |-> {}, adoptable |-> FALSE] @@ 2 :> [fenced |-> {}, rechecked |-> {}, deleted |-> {}, adoptable |-> FALSE]))
        /\
        mfCleanup = ({})
        /\
        inflight = ({})
...
\* to `JsonSerialize`. For example, a sub-sequence of _TETrace.
    \* ASSUME
    \*     LET J == INSTANCE Json
    \*         IN J!JsonSerialize("CaGcRootLocalPartManifestCore_TTrace_1785658994.json", _TETrace)
...
\*
\*trace == IODeserialize("CaGcRootLocalPartManifestCore_TTrace_1785658994.bin", TRUE)
\*
\*=============================================================================
\*
...
---- CONFIG CaGcRootLocalPartManifestCore_TTrace_1785658994 ----
CONSTANTS
    Namespaces = { n1 }
    Writers = { w1 }
    Leaders = { L1 }
...
ALIAS
    _expression
=============================================================================
\* Generated on Sun Aug 02 10:23:15 CEST 2026