---- MODULE CaGcAckFloorCore_TTrace_1785648263 ----
...
_inv ==
    ~(
        ...
        tok = ((b1 :> 1))
        /\
        wStatus = ((w1 :> "terminated" @@ w2 :> "unmounted"))
        /\
        minAckL = (5)
        /\
        round = (3)
...
\* to `JsonSerialize`. For example, a sub-sequence of _TETrace.
    \* ASSUME
    \*     LET J == INSTANCE Json
    \*         IN J!JsonSerialize("CaGcAckFloorCore_TTrace_1785648263.json", _TETrace)
...
\*
\*trace == IODeserialize("CaGcAckFloorCore_TTrace_1785648263.bin", TRUE)
\*
\*=============================================================================
\*
...
trace == 
    ...
    ([deadTok |-> (b1 :> {}),rebuiltEver |-> FALSE,deletedEver |-> FALSE,wAck |-> (w1 :> 0 @@ w2 :> 0),recreatedEver |-> FALSE,clampedEver |-> FALSE,sparedEver |-> FALSE,wView |-> (w1 :> 0 @@ w2 :> 0),nextTok |-> (b1 :> 2),tok |-> (b1 :> 1),wStatus |-> (w1 :> "live" @@ w2 :> "unmounted"),minAckL |-> 0,round |-> 0,wPending |-> (w1 :> {[b |-> b1, t |-> 1]} @@ w2 :> {}),copyForwardEver |-> FALSE,gcPhase |-> "idle",retired |-> {},present |-> (b1 :> TRUE),lostRefs |-> {},clampedL |-> FALSE,folded |-> {},landed |-> {}]),
    ([deadTok |-> (b1 :> {}),rebuiltEver |-> FALSE,deletedEver |-> FALSE,wAck |-> (w1 :> 0 @@ w2 :> 0),recreatedEver |-> FALSE,clampedEver |-> FALSE,sparedEver |-> FALSE,wView |-> (w1 :> 0 @@ w2 :> 0),nextTok |-> (b1 :> 2),tok |-> (b1 :> 1),wStatus |-> (w1 :> "live" @@ w2 :> "unmounted"),minAckL |-> 0,round |-> 0,wPending |-> (w1 :> {[b |-> b1, t |-> 1]} @@ w2 :> {}),copyForwardEver |-> FALSE,gcPhase |-> "running",retired |-> {},present |-> (b1 :> TRUE),lostRefs |-> {},clampedL |-> FALSE,folded |-> {},landed |-> {}]),
    ([deadTok |-> (b1 :> {}),rebuiltEver |-> FALSE,deletedEver |-> FALSE,wAck |-> (w1 :> 0 @@ w2 :> 0),recreatedEver |-> FALSE,clampedEver |-> FALSE,sparedEver |-> FALSE,wView |-> (w1 :> 0 @@ w2 :> 0),nextTok |-> (b1 :> 2),tok |-> (b1 :> 1),wStatus |-> (w1 :> "live" @@ w2 :> "unmounted"),minAckL |-> 0,round |-> 0,wPending |-> (w1 :> {} @@ w2 :> {}),copyForwardEver |-> FALSE,gcPhase |-> "running",retired |-> {},present |-> (b1 :> TRUE),lostRefs |-> {},clampedL |-> FALSE,folded |-> {},landed |-> {[b |-> b1, w |-> w1, t |-> 1]}]),
    ([deadTok |-> (b1 :> {}),rebuiltEver |-> FALSE,deletedEver |-> FALSE,wAck |-> (w1 :> 0 @@ w2 :> 0),recreatedEver |-> FALSE,clampedEver |-> FALSE,sparedEver |-> FALSE,wView |-> (w1 :> 0 @@ w2 :> 0),nextTok |-> (b1 :> 2),tok |-> (b1 :> 1),wStatus |-> (w1 :> "terminated" @@ w2 :> "unmounted"),minAckL |-> 0,round |-> 0,wPending |-> (w1 :> {} @@ w2 :> {}),copyForwardEver |-> FALSE,gcPhase |-> "running",retired |-> {},present |-> (b1 :> TRUE),lostRefs |-> {},clampedL |-> FALSE,folded |-> {},landed |-> {[b |-> b1, w |-> w1, t |-> 1]}]),
    ([deadTok |-> (b1 :> {}),rebuiltEver |-> FALSE,deletedEver |-> FALSE,wAck |-> (w1 :> 0 @@ w2 :> 0),recreatedEver |-> FALSE,clampedEver |-> FALSE,sparedEver |-> FALSE,wView |-> (w1 :> 0 @@ w2 :> 0),nextTok |-> (b1 :> 2),tok |-> (b1 :> 1),wStatus |-> (w1 :> "terminated" @@ w2 :> "unmounted"),minAckL |-> 0,round |-> 0,wPending |-> (w1 :> {} @@ w2 :> {}),copyForwardEver |-> FALSE,gcPhase |-> "folded",retired |-> {},present |-> (b1 :> TRUE),lostRefs |-> {},clampedL |-> FALSE,folded |-> {[b |-> b1, w |-> w1, t |-> 1]},landed |-> {}]),
    ([deadTok |-> (b1 :> {}),rebuiltEver |-> FALSE,deletedEver |-> FALSE,wAck |-> (w1 :> 0 @@ w2 :> 0),recreatedEver |-> FALSE,clampedEver |-> FALSE,sparedEver |-> FALSE,wView |-> (w1 :> 0 @@ w2 :> 0),nextTok |-> (b1 :> 2),tok |-> (b1 :> 1),wStatus |-> (w1 :> "terminated" @@ w2 :> "unmounted"),minAckL |-> 0,round |-> 1,wPending |-> (w1 :> {} @@ w2 :> {}),copyForwardEver |-> FALSE,gcPhase |-> "idle",retired |-> {},present |-> (b1 :> TRUE),lostRefs |-> {},clampedL |-> FALSE,folded |-> {[b |-> b1, w |-> w1, t |-> 1]},landed |-> {}]),
    ([deadTok |-> (b1 :> {}),rebuiltEver |-> TRUE,deletedEver |-> FALSE,wAck |-> (w1 :> 0 @@ w2 :> 0),recreatedEver |-> FALSE,clampedEver |-> FALSE,sparedEver |-> FALSE,wView |-> (w1 :> 0 @@ w2 :> 0),nextTok |-> (b1 :> 2),tok |-> (b1 :> 1),wStatus |-> (w1 :> "terminated" @@ w2 :> "unmounted"),minAckL |-> 0,round |-> 1,wPending |-> (w1 :> {} @@ w2 :> {}),copyForwardEver |-> FALSE,gcPhase |-> "idle",retired |-> {},present |-> (b1 :> TRUE),lostRefs |-> {[b |-> b1, w |-> w1, t |-> 1]},clampedL |-> FALSE,folded |-> {},landed |-> {}]),
    ([deadTok |-> (b1 :> {}),rebuiltEver |-> TRUE,deletedEver |-> FALSE,wAck |-> (w1 :> 0 @@ w2 :> 0),recreatedEver |-> FALSE,clampedEver |-> FALSE,sparedEver |-> FALSE,wView |-> (w1 :> 0 @@ w2 :> 0),nextTok |-> (b1 :> 2),tok |-> (b1 :> 1),wStatus |-> (w1 :> "terminated" @@ w2 :> "unmounted"),minAckL |-> 5,round |-> 1,wPending |-> (w1 :> {} @@ w2 :> {}),copyForwardEver |-> FALSE,gcPhase |-> "running",retired |-> {},present |-> (b1 :> TRUE),lostRefs |-> {[b |-> b1, w |-> w1, t |-> 1]},clampedL |-> FALSE,folded |-> {},landed |-> {}]),
    ([deadTok |-> (b1 :> {}),rebuiltEver |-> TRUE,deletedEver |-> FALSE,wAck |-> (w1 :> 0 @@ w2 :> 0),recreatedEver |-> FALSE,clampedEver |-> FALSE,sparedEver |-> FALSE,wView |-> (w1 :> 0 @@ w2 :> 0),nextTok |-> (b1 :> 2),tok |-> (b1 :> 1),wStatus |-> (w1 :> "terminated" @@ w2 :> "unmounted"),minAckL |-> 5,round |-> 1,wPending |-> (w1 :> {} @@ w2 :> {}),copyForwardEver |-> FALSE,gcPhase |-> "folded",retired |-> {},present |-> (b1 :> TRUE),lostRefs |-> {[b |-> b1, w |-> w1, t |-> 1]},clampedL |-> FALSE,folded |-> {},landed |-> {}]),
    ([deadTok |-> (b1 :> {}),rebuiltEver |-> TRUE,deletedEver |-> FALSE,wAck |-> (w1 :> 0 @@ w2 :> 0),recreatedEver |-> FALSE,clampedEver |-> FALSE,sparedEver |-> FALSE,wView |-> (w1 :> 0 @@ w2 :> 0),nextTok |-> (b1 :> 2),tok |-> (b1 :> 1),wStatus |-> (w1 :> "terminated" @@ w2 :> "unmounted"),minAckL |-> 5,round |-> 2,wPending |-> (w1 :> {} @@ w2 :> {}),copyForwardEver |-> FALSE,gcPhase |-> "idle",retired |-> {[b |-> b1, t |-> 1, r |-> 2]},present |-> (b1 :> TRUE),lostRefs |-> {[b |-> b1, w |-> w1, t |-> 1]},clampedL |-> FALSE,folded |-> {},landed |-> {}]),
    ([deadTok |-> (b1 :> {}),rebuiltEver |-> TRUE,deletedEver |-> FALSE,wAck |-> (w1 :> 0 @@ w2 :> 0),recreatedEver |-> FALSE,clampedEver |-> FALSE,sparedEver |-> FALSE,wView |-> (w1 :> 0 @@ w2 :> 0),nextTok |-> (b1 :> 2),tok |-> (b1 :> 1),wStatus |-> (w1 :> "terminated" @@ w2 :> "unmounted"),minAckL |-> 5,round |-> 2,wPending |-> (w1 :> {} @@ w2 :> {}),copyForwardEver |-> FALSE,gcPhase |-> "running",retired |-> {[b |-> b1, t |-> 1, r |-> 2]},present |-> (b1 :> TRUE),lostRefs |-> {[b |-> b1, w |-> w1, t |-> 1]},clampedL |-> FALSE,folded |-> {},landed |-> {}]),
    ([deadTok |-> (b1 :> {}),rebuiltEver |-> TRUE,deletedEver |-> FALSE,wAck |-> (w1 :> 0 @@ w2 :> 0),recreatedEver |-> FALSE,clampedEver |-> FALSE,sparedEver |-> FALSE,wView |-> (w1 :> 0 @@ w2 :> 0),nextTok |-> (b1 :> 2),tok |-> (b1 :> 1),wStatus |-> (w1 :> "terminated" @@ w2 :> "unmounted"),minAckL |-> 5,round |-> 2,wPending |-> (w1 :> {} @@ w2 :> {}),copyForwardEver |-> FALSE,gcPhase |-> "folded",retired |-> {[b |-> b1, t |-> 1, r |-> 2]},present |-> (b1 :> TRUE),lostRefs |-> {[b |-> b1, w |-> w1, t |-> 1]},clampedL |-> FALSE,folded |-> {},landed |-> {}]),
    ([deadTok |-> (b1 :> {1}),rebuiltEver |-> TRUE,deletedEver |-> TRUE,wAck |-> (w1 :> 0 @@ w2 :> 0),recreatedEver |-> FALSE,clampedEver |-> FALSE,sparedEver |-> FALSE,wView |-> (w1 :> 0 @@ w2 :> 0),nextTok |-> (b1 :> 2),tok |-> (b1 :> 1),wStatus |-> (w1 :> "terminated" @@ w2 :> "unmounted"),minAckL |-> 5,round |-> 3,wPending |-> (w1 :> {} @@ w2 :> {}),copyForwardEver |-> FALSE,gcPhase |-> "idle",retired |-> {},present |-> (b1 :> FALSE),lostRefs |-> {[b |-> b1, w |-> w1, t |-> 1]},clampedL |-> FALSE,folded |-> {},landed |-> {}])
    >>
----
...
---- CONFIG CaGcAckFloorCore_TTrace_1785648263 ----
CONSTANTS
    Writers = { w1 , w2 }
    Blobs = { b1 }
    MaxRound = 4
...
ALIAS
    _expression
=============================================================================
\* Generated on Sun Aug 02 07:24:25 CEST 2026