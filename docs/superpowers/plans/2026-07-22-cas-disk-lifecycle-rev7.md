...
# (T12 final schema, PINNED: lifecycle_reason is ENUM-CLEAN (forgotten/erased/replaced, else empty);
#  the full [D5] text lives in lifecycle_detail. A gtest pins this exact concatenation.)
