...
(revision 24, 2026-09-04), which supersedes the fix sketch below where they differ.
...
(revision 24, 2026-09-04, after fifteen codex and six opus review rounds; the sixth opus round judged it ready to plan from, the fifteenth codex round restored two rules the rev.21 rewrite had lost): a per-pool write lane
