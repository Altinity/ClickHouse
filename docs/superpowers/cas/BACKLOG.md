...
(revision 28, phase A, 2026-09-04), which supersedes the fix sketch below where they differ; the
...
(revision 28, phase A, 2026-09-04). Phase A is the fix sketch above minus nothing it needs: a per-pool
