...
class S33(Scenario):
    ...
    Issuing explicit `SYSTEM CONTENT ADDRESSED GARBAGE COLLECTION ca` on BOTH replicas concurrently
    ...
    def run(self, ctx, result):
        ...
        # `SYSTEM CONTENT ADDRESSED GARBAGE COLLECTION ca` on node1 and node2 simultaneously.
        nodes = cl.nodes()
        node_a = nodes[0]
